var fs    = require('fs');
var path_auto = 'G:/Teca/VAS/4210/';
var path_manual = 'G:/Teca/VAS/XuatTay/';
...
async function xuat_xml(id_thutrano,duongdan){
	console.log("XUAT FILE IDTNN:"+id_thutrano+", VAO THU MUC:"+duongdan);
	try {
		...
		await console.log(duongdan+filename+" was saved!");		
...
async function caccachuathanhtoan(){
		console.log("KIEM TRA LUOT CHUA CHUYEN");
