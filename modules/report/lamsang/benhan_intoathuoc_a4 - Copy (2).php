...
#watermark {
 ...
 <?=HeaderReportA4()?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0px;padding-left:5px!important" >
		...
		Giới tính: <?=$thongtinluotkham[0]["Gioi"]?> - <?=$thongtinluotkham[0]["Tuoi_thangsinh"]?> - ĐT: <?=$thongtinluotkham[0]["DienThoaiBN"]?><br>
		...
		if($thongtinluotkham[$i]['ID_NhomThuoc']!=6 && $thongtinluotkham[$i]['ID_NhomThuoc']!=14 && $thongtinluotkham[$i]['ID_NhomThuoc']!=3
		 && $thongtinluotkham[$i]['LaThuoc']==1){
			...
			if($thongtinluotkham[$i]["SoThuocThucXuat"]<=9){
				...
				echo('<td width="100%" ><div style="display:table-cell;width:600px"><strong>' .($y) .' . '.$thongtinluotkham[$i][$_GET['tenin']].' </strong></div><div style="display:table-cell">
				 ...
				 <div  style="display:table-cell;width:500px;text-align:center; vertical-align:bottom" >	
				 	<table cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tr>
							...
							<td style="vertical-align:bottom"> <strong>BÁC SĨ KÊ ĐƠN</strong><br><img id="bs_chandoan" width="100"/><br>			
