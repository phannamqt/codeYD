   ...
   <table cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
		...
		?>
          ...
          <td style="width:3px; text-align:left;padding-top:2px; vertical-align:top;"><?=$i;?></td>
					<td <?php if($ttcd["ID_TrangThai"]=='Xong') {?>bgcolor="#CCCCCC" <?php }?>   style=" width:50%; text-align:left; padding-left:1px; padding-top:2px; padding-bottom:2px;padding-right:2px;">
				   <?=$ttcd["TenLoaiKham"]; ?>
					</td>
