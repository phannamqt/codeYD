  ...
  <?=HeaderReportInNhiet()?>    
    ...
    <table cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
        <tr style="border-bottom:solid 1px #000000 !important; font-weight:bold;">
            ...
            <td style=" width:5%; text-align:center; padding-left:2px; border-bottom:solid 1px #000000 !important;; border-top:solid 1px #000000 !important;  padding-top:2px; padding-bottom:2px;">
            L
            </td >
            <td style=" width:5%; text-align:center; padding-left:2px; border-bottom:solid 1px #000000 !important;; border-top:solid 1px #000000 !important;  padding-top:2px; padding-bottom:2px;">
            N
            ...
            Phòng
           	...
           	<td style=" width:30%; text-align:right; padding-right:0px; border-bottom:solid 1px #000000 !important;; border-top:solid 1px #000000 !important; padding-top:2px; padding-bottom:2px;">
            BS CĐ
            </td>
        </tr>
		...
		?>
				<tr>
                	<td style=" width:5px; text-align:left;padding-top:2px; vertical-align:top;"><?=$i;?></td>
					<td <?php if($ttcd["ID_TrangThai"]=='Xong') {?>bgcolor="#F5F5F5" <?php }?> style=" width:40%; text-align:left; padding-left:2px; padding-top:2px; padding-bottom:2px;">
				   <?=$ttcd["TenLoaiKham"]; ?>
					</td>
					<td  style=" width:5%; text-align:center; padding-left:2px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["SoLanThucHienTrongNgay"]; ?>
					</td>
                    <td  style=" width:5%; text-align:center; padding-left:2px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["SoNgayThucHien"]; ?>
					</td>
                    <td  style=" width:15%; text-align:center; padding-left:2px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["PhuongThucThucHien"]; ?>
					</td>
                    <td style=" width:15%; text-align:center; padding-left:2px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
                    <?=$ttcd["TenPhong"]; ?>
                    </td>
                    <td  style=" width:32%; text-align:right; padding-right:0px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["NickName"]; ?>
					</td>
				</tr>
        <?php
		...
		?>
         ...
         <tr>
        	<td  style=" width:100%; border-bottom:solid 1px #000000 !important;" colspan="7">
            </td>
        </tr>
    </table>
    <br />
