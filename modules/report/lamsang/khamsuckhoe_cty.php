...
<tr>
    ...
    <fieldset style="width:93%; font-size:13px;padding-left:15px;">
        ...
        <div style="line-height:18px !important;"><strong>Tiền sử gia đình:</strong> Có ai trong gia đình (ông, bà, cha, mẹ, anh chị em ruột) mắc một trong các bệnh sau:<br />Tăng huyết áp, Bệnh tim mạch, Tiểu đường, Hen phế quản, Động kinh, Rối loạn tâm thần, Liệt, Những bệnh</div> nặng khác:<input type='text' class='nam3'><br />
