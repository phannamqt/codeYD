...
?>
  ...
  <?=$khamlamsang[0]['SanPhuKhoa_KL']?><br />
  <?php
}
?>
...
<div class="con">- Thị lực: <?php if($khamlamsang[0]['MatPhai_CK']>0 || $khamlamsang[0]['MatTrai_CK']>0){ ?>Có kính: Mắt phải: 
<?=$khamlamsang[0]['MatPhai_CK']?>
/10&nbsp;&nbsp; Mắt trái:   
<?=$khamlamsang[0]['MatTrai_CK']?>
/10 &nbsp;&nbsp;&nbsp;. <?php }?>Không kính: Mắt phải: 
