...
$store_name3="{call [Gd2_KeToan_SYT_DeNguoc](?,?)}";
...
<div id="wrapper" style="text-align:center;">
	<div style="text-align:center;font-size:18px; font-weight:bold">TỔNG HỢP CÁC CA ĐẺ NGƯỢC</div>
    <?php
...
<?php
	if($types=="excel"){
		...
		$exp->exportWithPage("excel/temp.html","GD2_KeToanBaoCaoSYT_DeNguoc.xls");
	}
	?>