...
<?php
	...
	$store_name="{call GD2_baocaongoaitru_bhyt (?,?)}";
...
<body>
<div id="wrapper">
  <div style="text-align:center;font-size:18px; font-weight:bold">DANH SÁCH NGƯỜI BỆNH BẢO HIỂM Y TẾ KHÁM CHỮA BỆNH NGOẠI TRÚ ĐỀ NGHỊ THANH TOÁN</div>
    <?php
  ...
  <thead >
    	<tr style="border:solid 1px #000000 !important;border-top-color:solid 1px #000000">
	          ...
	          <td style="border:solid 1px #000000 !important;width:10%;" rowspan="2"  align="center" ><b></b>Tổng
	            cộng</td>
	          <td style="border:solid 1px #000000 !important;width:10%;" rowspan="2"  align="center" ><b></b>Người 
	            bệnh
	            cùng
	            chi trả</td>
	        ...
	        <tr >
	          ...
	          <td style="border:solid 1px #000000 !important;" align="center">CDHA-
	            TDCN</td>
	          <td style="border:solid 1px #000000 !important;" align="center">Thuốc,
	            DT</td>
	          ...
	          <td style="border:solid 1px #000000 !important;" align="center">DVKT  
	            cao</td>
	          <td style="border:solid 1px #000000 !important;" align="center">Thuốc 
	            K,thải 
	            ghép ngoài danh mục</td>
	          <td style="border:solid 1px #000000 !important;" align="center">Tiền 
	            Giường</td>
	          <td style="border:solid 1px #000000 !important;" align="center">CP 
	            VC</td>
		   ...
		   $ThuocUT=0;$VC=0;$Tong=0;$ThuocUT=0;$ThanhTienCungChiTra=0;$ThanhTienBaoHiem=0;$KB=0;
		//$stt=1;
        ...
        foreach ($tam as $row) {//duyet toan bo mang tra ve
			...
			echo '<td align="right">'.$row["MaICD10"]."</td>";
			echo '<td align="right">'.$row["thoigianvaokham"]."</td>";
			echo '<td align="right">'.$row["ThoiGianKetThucKham"]."</td>";
			...
			echo '<td align="left">'.$row["khoa"]."</td>";
			echo '<td align="left">'.' '."</td>";
...
<?php
	if($types=="excel"){
		...
		$exp->exportWithPage("excel/temp.html","excel_bhyt_tonghopngoaitru.xls");
	}
	?>