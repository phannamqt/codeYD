...
$store_name3="{call [GD2_DoanhThu_HanQuoc](?,?)}";
...
<div id="wrapper" style="text-align:center;">
	<div style="text-align:center;font-size:18px; font-weight:bold">DOANH THU BIEL HÀN QUỐC</div>
    <?php
...
<?php
	if($types=="excel"){
		...
		$exp->exportWithPage("excel/temp.html","GD2_DoanhThu_HanQuoc.xls");
	}
	?>