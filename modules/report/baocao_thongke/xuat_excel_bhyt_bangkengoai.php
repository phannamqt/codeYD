...
<?php
	...
	$store_name="{call GD2_baocaongoaitrubangke_bhyt (?,?)}";
...
CHO NGƯỜI BỆNH BHYT ĐIỀU TRỊ NGOẠI TRÚ</div>
    <?php
...
<?php
	if($types=="excel"){
		...
		$exp->exportWithPage("excel/temp.html","excel_bangke_bhyt_ngoaitru.xls");
	}
	?>