...
$store_name3="{call [Gd2_KeToan_SYT_LoaiKham](?,?)}";
...
<div id="wrapper" style="text-align:center;">
	<div style="text-align:center;font-size:18px; font-weight:bold">TỔNG HỢP LOẠI KHÁM</div>
    <?php
...
<?php
	if($types=="excel"){
		...
		$exp->exportWithPage("excel/temp.html","GD2_KeToanBaoCaoSYT_LoaiKham.xls");
	}
	?>