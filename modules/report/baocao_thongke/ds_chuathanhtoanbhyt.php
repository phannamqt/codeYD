...
<body>
  ...
  <thead>
       <tr style="border:solid 1px #000000 !important;border-top-color:solid 1px #000000">
          ...
          <td style="border:solid 1px #000000 !important;"  ><strong>Đối tượng</strong></td>
		  <td style="border:solid 1px #000000 !important;"  ><strong>Phòng ban</strong></td>		
      </tr>
  </thead>
           <?php
		   $stt=0;
        ...
        foreach ($tam as $row) {//duyet toan bo mang tra ve
			...
			echo '<td align="left">'.$row["ngay"]."</td>";
			echo '<td align="left">'.$row["doituong"]."</td>";
