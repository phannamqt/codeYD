...
$store_name3="{call [GD2_LSPSelectByNhomIDNhanVien](?,?,?,?)}";

$params3 = array($_GET['id_nhanvien'],$_GET['thang'],$_GET['nam'],785);
...
<?php
	if($types=="excel"){
		...
		$exp->exportWithPage("excel/temp.html","Xuat_LSP_Nhom_".$_GET['thang']."_".$_GET['nam'].".xls");
	}
	?>