...
<body>
	...
	<?=HeaderReportA4()?>
    <?=ThongTinhanhChinhReportA4(($thongtinluotkham[0]["ReportName"]==''?$thongtinluotkham[0]["TenLoaiKham_EN"]:$thongtinluotkham[0]["ReportName"]),$thongtinbenhnhan[0]["HoLotBenhNhan"]." ".$thongtinbenhnhan[0]["TenBenhNhan"],$thongtinbenhnhan[0]["Gioi"],$thongtinbenhnhan[0]["Tuoi"],$thongtinbenhnhan[0]["MaBenhNhan"],$thongtinbenhnhan[0]["DiaChi"])?>
    ...
    <script type="application/javascript">
		$(document).ready(function() {
			...
			<?php 
				...
				echo "var _id_loaikham=".$thongtinluotkham[0]["ID_LoaiKham"].";";
			?>
			_split_link= _links.split(":::");
			//alert(parseInt(_split_link.length));
			if(parseInt(_split_link.length)>1){
				...
				if(_id_loaikham==6875){// if nếu là loại khám sắc giác
					$("#images_container").append(' <img width="180px" height="180px" src="./modules/report/canlamsang/img/img_sac-giac.png"  /><div style="height:7px"></div> ');
					$("#images_container").append(' <img width="180px" height="180px" src="./modules/report/canlamsang/img/img_sac-giac_2.png"  /><div style="height:7px"></div> ');
					$("#images_container").append(' <img width="180px" height="180px" src="./modules/report/canlamsang/img/img_sac-giac_3.png"  /><div style="height:7px"></div> ');
				}
			}
			print_preview();
		});
