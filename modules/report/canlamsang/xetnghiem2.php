...
<body style=" margin-left:55px;">
   ...
   <?=HeaderReportA4()?>
    <?=ThongTinhanhChinhReportA4("KẾT QUẢ XÉT NGHIỆM Y KHOA",$thongtinbenhnhan[0]["HoLotBenhNhan"]." ".$thongtinbenhnhan[0]["TenBenhNhan"],$thongtinbenhnhan[0]["Gioi"],$thongtinbenhnhan[0]["Tuoi"],$thongtinbenhnhan[0]["MaBenhNhan"],$thongtinbenhnhan[0]["DiaChi"]." - ĐT: ".$thongtinbenhnhan[0]["DienThoai1"])?>
		 ...
		 if( $NguoiDuyet==-1){
			 ...
			 ?>
				...
				<tr>
				  ...
				  <tr>
					<td  align="center" valign="bottom"><b><!--KTV Phạm Thị Thùy An--></b></td>
				<!--     <td style="padding-top:40px" align="center" ><b style="color:red" ><?=$viettat.' '.$nhanvien?></b></td> -->
				</tr>
			 <?php
		 }
		 ?>
