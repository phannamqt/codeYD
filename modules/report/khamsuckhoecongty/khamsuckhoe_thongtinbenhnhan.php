...
<body>
    ...
    ?>
     ...
     <tr>
       <td align="center" width="50%" style="font-weight:bold; font-size:13px; padding-top:8px;"> 
    ...
    <fieldset style="width:95%; font-size:13px;padding-left:15px;">
