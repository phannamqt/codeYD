...
<table cellpadding="0" cellspacing="0" border="0" style="line-height:1.7;font-size:14px; width:95%;font-family:Tahoma, Geneva, sans-serif; border-top:1px solid #000;">
         <tr>
            ...
            <td>Số thẻ BHYT: <?=$thongtinluotkham[0]["SoThe"];?></td>
         ...
         <tr>
                ...
                <td align="right" valign="top"><em>Thành tiền: </em><em><?php echo number_format($thongtinluotkham[0]["giachamsoc"],"0",",",".").'&nbsp;VNĐ';?>
                </em></td>
                </td>
         </tr>
         <tr>
                ...
                <?=$thongtinluotkham[0]["Cap1"];?>&nbsp;ngày&nbsp;&nbsp;cấp 2: <?=$thongtinluotkham[0]["Cap2"];?>&nbsp;ngày&nbsp;&nbsp;cấp 3: <?=$thongtinluotkham[0]["Cap3"];?>&nbsp;ngày</td>
         ...
         <tr>
                ...
                <td colspan="2" ><strong>5. Giường:</strong> <?=$thongtinluotkham[0]["TenBuong_Giuong"];?></td>
                <td align="right" valign="top" ><em>Thành tiền:
                <?php echo number_format($thongtinluotkham[0]["GiaGiuong"],"0",",",".").'&nbsp;VNĐ';?>
                </em></td>
         </tr>
         <tr>
           
                <td colspan="3">
                <strong>6. Thuốc và vật tư y tế tiêu hao</strong>:
				...
				for($i=0;$i<=count($thongtinthuoc)-1;$i++){
					$tong=$tong+($thongtinthuoc[$i]['DonGia']*$thongtinthuoc[$i]['SoLuong']);
					...
					if($thongtinthuoc[$i]['LaThuoc']==0){
						$tongvt=$tongvt+($thongtinthuoc[$i]['DonGia']*$thongtinthuoc[$i]['SoLuong']);
					}
					if($i%2==0){
						...
						if(($thongtinthuoc[$i]['DonGia']* $thongtinthuoc[$i]['SoLuong'])==0){
							echo "";	
						}else{
          ...
          <tr>
                ...
                <td colspan="3" style=""><strong>7. Cận lâm sàng:</strong><?php 
         ...
         <?php
		 if($thongtinluotkham[0]['LoaiDoiTuongKham']!='BHYT'){
		 ?>
         <tr>
            <td colspan="3" style=""><strong>8. Giảm giá dịch vụ: </strong><?php 
            echo '<i>'.number_format($thongtinluotkham[0]['KhauHaoDichVu_KhamChinh'],"0",",",".").'&nbsp;VNĐ</i>' ;
            ?>
            </td>
         </tr>
        <tr>
            ...
            <table>
            	<tr>
                	<td style="width:280px"><strong>Kinh phí dự kiến (2+3+4+5+6+7-8) là:</strong></td>
                    <td><strong><?php 
                //echo $tong;
                $tong=$tong+$thongtinluotkham[0]["DonGia_KhamChinh"]+$thongtinluotkham[0]["giachamsoc"]+$thongtinluotkham[0]["giachamsoc"]+$tongtphau+$thongtinluotkham[0]["GiaGiuong"]-$thongtinluotkham[0]['KhauHaoDichVu_KhamChinh']; 
                echo number_format($tong,"0",",",".").'&nbsp;VNĐ'; 
                
            ?></strong></td>
                </tr>
                <tr>
                	<td colspan="2"><strong><div class="tongtien"></div></strong></td>
                </tr>
            </table>
             </td>
         </tr>
         ...
         <tr>
            <td colspan="3"><table>
            	<tr>
                	<td style="width:270px"><strong>Kinh phí dự kiến (2+3+4+5+6+7) là:</strong></td>
                    <td><strong><?php 
                //echo $tong;
                 $tong=$tong+$thongtinluotkham[0]["DonGia_KhamChinh"]+$thongtinluotkham[0]["giachamsoc"]+$thongtinluotkham[0]["giachamsoc"]+$tongtphau+$thongtinluotkham[0]["GiaGiuong"]; 
                echo number_format($tong,"0",",",".").'&nbsp;VNĐ'; 
         ...
         <tr>
              ...
              <td width="90%" colspan="2" valign="top" style=" font-style: italic;">
              <strong><em>
              - Kinh phí trên không áp dụng cho dịch vụ BHYT và BH cao cấp.<br />
              - Giá phẫu thuật trên  không bao gồm thuốc, VTTH phòng mổ. <br />
              - Các chi phí trên đây là dự kiến, nó sẽ thay đổi theo tình trạng bệnh lý của từng bệnh nhân. Bác sĩ sẽ trực tiếp trao đổi với bệnh nhân hoặc người nhà bệnh nhân khi có sự thay đổi.
              </em></strong></td>
          </tr>
