...
<?php
	...
	$store_name="{call GD2_GiaoNhanTheThanhVien_Excel_Sent_NhaInDap (?,?)}";
...
<body>
  ...
  <div style="text-align:center;font-size:18px; font-weight:bold">DANH SÁCH THẺ THÀNH VIÊN ĐÃ GỬI CHO NHÀ IN DẬP</div>
  	<table border="1" cellpadding="0" cellspacing="0" align="center" style="width:2000px;margin-top:5px">
		...
		<tr height="30">    	
            ...
            <td width="150" align="left"><?=$row['Rh']?></td>
            <td width="150" align="left"><?=$row['MayTao']?></td>
      </tr>
      <?php
      $i++;
		}		
