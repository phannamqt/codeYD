...
<table cellpadding="0" cellspacing="0" border="0" style="line-height:1.7;font-size:14px; width:95%;font-family:Tahoma, Geneva, sans-serif; border-top:1px solid #000;">
		 ...
		 ?>
         <tr>
            <td colspan="3" style=""><strong>7. Giảm giá dịch vụ: </strong><?php 
            echo '<i>'.number_format($thongtinluotkham[0]['KhauHaoDichVu_KhamChinh'],"0",",",".").'&nbsp;VNĐ</i>' ;
            ?>
            </td>
         </tr>
        <tr>
            <td colspan="3"><br /> <strong>Kinh phí dự kiến (2+3+4+5+6-7) là:
            <?php 
                //echo $tong;
                $tong=$tong+$thongtinluotkham[0]["DonGia_KhamChinh"]+$thongtinluotkham[0]["giachamsoc"]+$thongtinluotkham[0]["giachamsoc"]+$tongtphau-$thongtinluotkham[0]['KhauHaoDichVu_KhamChinh']; 
		 ...
		 ?>
         <tr>
            <td colspan="3"><br /> <strong>Kinh phí dự kiến (2+3+4+5+6) là:
            <?php 
                //echo $tong;
         ...
         <tr>
              ...
              <strong><em>
              - Kinh phí trên chưa bao gồm tiền giường điều trị và dịch vụ BHYT.<br />
              - Chi phí trên không áp dụng cho dịch vụ bảo hiểm cao cấp.<br />
