...
<?php
	...
	$store_name="{call GD2_KSK_XNALLBYIdGoiKham (?)}";//tao bien khai bao store
...
<body>
	 ...
	 <span  style="font-weight:bold;font-size:16px;"> <?=$_GET['tencongty']?> </span><br />
        ...
        <!-- <tr>
         <th width="10%" colspan="7" scope="col">Chi phí(A)</th>
         <th width="10%" colspan="59" scope="col">Chi phí(A)</th>
        </tr> -->
          <tr>
            <th >STT</th>
            <th >ID Bệnh nhân</th>
           
            <th width="20%" >Họ lót</th>
            <th >Tên</th>
					...
					foreach ($thongtin as $key => $value) {
						...
						foreach($value as $key2 => $value2){
							...
							{   
								...
								//echo '<th>'.$cell.'<br>[<span style="color:red">'.$t3.'</span>]</th>';
									echo '<th>'.$cell.'</th>';
