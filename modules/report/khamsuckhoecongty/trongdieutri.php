...
<table cellpadding="0" cellspacing="0" border="0" style="width:95%;font-family:Tahoma, Geneva, sans-serif;color:#00b38b">
        <tr>
             <td style="text-align:center">
                <span style="letter-spacing: 0.5px;font-weight:bold;font-size:26px;color:#000!important">HƯỚNG DẪN BỆNH NHÂN<br /> TRONG KHI ĐIỀU TRỊ NỘI TRÚ </span><br />
...
<table cellpadding="0" cellspacing="0" border="0" style="width:95%;font-family:Tahoma, Geneva, sans-serif;    font-size: 16px; margin-top:20px!important">
	<tr>
    	<td><pre style="font-family:Tahoma, Geneva, sans-serif!important;font-size:16px; line-height:25px; margin-top:20px!important"><?php  echo $thongtinluotkham[0]["TrongDieuTri"]?></pre></td>
    </tr>
    <tr><td align="center"><strong>CHÚNG TÔI SẴN SÀNG GIÚP ĐỠ BẠN, HÃY BÁO CHO NHÂN VIÊN Y TẾ NHỮNG BẤT THƯỜNG MÀ BẠN GẶP PHẢI TRONG QUÁ TRÌNH ĐIỀU TRỊ</strong></td></tr>
</table>
