...
<table cellpadding="0" cellspacing="0" border="0" style="line-height:1.7;font-size:14px; width:95%;font-family:Tahoma, Geneva, sans-serif; border-top:1px solid #000;">
         ...
         <tr>
                ...
                <td colspan="2" ><strong>2. Phương pháp phẫu thuật:</strong> <?php echo $thongtinluotkham[0]["TenLoaiKham"]; 
				//$tong=$tong+$thongtinluotkham[0]["DonGia_KhamChinh"]?>
                </td>
                <td width="24%" align="right" valign="top" ><div align="left"><em>Đơn giá:</em></div></td>
                <td width="12%" align="right" valign="top" ><em><?php echo number_format($thongtinluotkham[0]["DonGia_KhamChinh"],"0",",",".").'&nbsp;VNĐ';?>
                </em></td>
         </tr>
         <tr>
                ...
                <td width="24%" align="right" valign="top" ><div align="left"><em>Khấu trừ VTTH trong mổ:</em></div></td>
                <td width="12%" align="right" valign="top" ><em><?php echo number_format($thongtinluotkham[0]["DonGia_KhamChinh"],"0",",",".").'&nbsp;VNĐ';?>
                </em></td>
         </tr>
         <tr>
                ...
                <td width="24%" align="right" valign="top" ><div align="left"><em>Thành tiền: </em></div></td>
                <td width="12%" align="right" valign="top" ><em><?php echo number_format($thongtinluotkham[0]["DonGia_KhamChinh"],"0",",",".").'&nbsp;VNĐ';?>
                </em></td>
         </tr>
         <tr>
                ...
                <td align="right" valign="top"><div align="left"><em>Thành tiền:</em></div></td>
         ...
         <tr>
                ...
                <td align="right" valign="top" ><div align="left"><em>Thành tiền:</em></div></td>
                <td align="right" valign="top" ><em><?php echo number_format($thongtinluotkham[0]["giachamsoc"],"0",",",".").'&nbsp;VNĐ';?>
                </em></td>
         </tr>
         <tr>
          ...
          <tr>
                ...
                <td colspan="4" style=""><strong>6. Cận lâm sàng:</strong><?php 
         ...
         <tr>
                ...
                <td colspan="4"><br /> <strong>Kinh phí dự kiến:
                
                <?php 
					//echo $tong;
					$tong=$tong+$thongtinluotkham[0]["DonGia_KhamChinh"]+$thongtinluotkham[0]["giachamsoc"]+$thongtinluotkham[0]["giachamsoc"]+$tongtphau; 
         ...
         <tr>
                  ...
                  <td width="33%" valign="top" style=" font-style: italic;"><strong><em>*Lưu ý:</em></strong></td>
                  <td colspan="3" valign="top" style=" font-style: italic;"><strong><em>-Kinh phí trên chưa bao gồm tiền giường điều trị , dịch vụ BHYT và không áp dụng cho dịch vụ bảo hiểm cao cấp.<br />
