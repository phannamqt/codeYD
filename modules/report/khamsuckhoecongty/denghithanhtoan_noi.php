...
<body>
	...
	//echo $_GET["idbenhannoitru"];
        ...
        $store_name1="{call GD2_SelectTop_KhoaNoiTru(?)}";//tao bien khai bao store
		...
		if($quanlynguoibenh[0]["ID_PhongBan"]=='318'||$quanlynguoibenh[0]["ID_PhongBan"]=='312'){
			$tang='2';
		}else{
			$tang='4';
		}
