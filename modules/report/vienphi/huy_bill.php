       ...
       <div class="n_top">
        ...
        <tr>
                    <td colspan="6" style="text-align:center; font-weight:bold; font-size:20px">
                       BẢNG KÊ HỦY PHIẾU DỊCH VỤ<br />
                        Từ ngày <?=$_GET['tungay']?> đến ngày <?=$_GET['denngay']?><br />
                  </td>
                </tr>
          <tr>
            <th width="30px">NGÀY</th>
            <th width="400px">SỐ CT</th>
            <th width="70px">SỐ PHIẾU</th>
            <th width="70px">SỐ TIỀN</th>
            <th width="90px">LÝ DO HỦY PHIẾU</th> 
            <th width="90px">GHI CHÚ</th> 
