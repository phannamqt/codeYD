     ...
     <div id="page_1" class="page" style="page-break-after: always; padding-left: 10px; padding-top:5px">
       <div class="n_top">
         ...
         <table  width="700px" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="text-align:center; font-weight:bold; font-size:20px">PHIẾU XUẤT KHO<br />
                      <br />
                         Ngày 
                        <?=$thongtinnv[0]["GioLap"]->format('d/m/Y')?><br />
                  </td>
                </tr>
            </table>
            <br />
...
$sum=0;
            ...
            <td colspan="3"><div align="right">Tổng cộng</div></td>
		   ...
		   <br />
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			    ...
			    <td width="273" style="text-align:center"> <div align="right"><em>Ngày
  <?=$thongtinnv[0]["GioLap"]->format('d/m/Y')?>
		        </em></div></td>
			  </tr>
