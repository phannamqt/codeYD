	...
	<div id="page_1" class="page" style="page-break-after: always; padding-left: 10px; padding-top:5px"> 
		<table id="bang_1" cellpadding="0" cellspacing="0" border="1">
			...
			<tr class="summary">
				...
				<td>  <?=(float)($TongCong)?></td>
				<td> <?=(float)($BaoHiemTra)?></td>
				<td>  <?=(float)($BenhNhanTra)?></td>
				<td>  <?=(float)($TongCongDVKT)?></td>
				<td> <?=(float)($ThanhTienBaoHiemDVKT)?></td>
				<td> <?=(float)($BenhNhanTraDVKT)?></td>
				<td> <?=(float)($TongCongThuoc)?></td>
				<td>  <?=(float)($ThanhTienBaoHiemThuoc)?></td>
				<td>  <?=(float)($BenhNhanTraThuoc)?></td>
				<td>  <?=(float)($ThanhTienPhuThuBenhVien)?></td>
