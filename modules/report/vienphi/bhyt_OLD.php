...
<body style="overflow: scroll;">
    ...
    <tr>
     ...
     <tr>
    	<td style=" width:70%; text-align:left;"><strong>Cở sở khám,chữa bệnh:  <?=$_SESSION["com"]["TenBenhVien"]?></strong></td>
             ...
             <tr style="border:solid 1px #000000 !important;border-top-color:solid 1px #000000">
              ...
              $sophimbhyt = 0;
				  ...
				  echo '</tr>';
				   ...
				   echo '<tr style=" border:1px solid #000;">';
				   		   echo '<td colspan=7 bgcolor="#CCCCCC" style="border:solid 1px #000000 !important;text-align:center;"><strong>Tổng cộng</strong></td>';
