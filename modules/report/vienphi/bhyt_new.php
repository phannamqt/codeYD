              ...
              $sophimbhyt = 0;
			  	for($i=0;$i<count($bhyt)-1;$i++){
					...
					if($bhyt[$i]['id_loai']==null){
						...
						if($bhyt[$i]['bhyt']==-1){					
						   ...
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[$i]['ThanhTienDonGiaBV'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[$i]['thanhtien'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[$i]['ThanhTienBaoHiem'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[$i]['nguoibenh'],"0",",",".").'</td>'; 
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;"></td>'; 
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[$i]['ThanhTienChiTraBV'],"0",",",".").'</td>'; 
						}else{	
						$sophimbhyt += $bhyt[$i]['SoLuongPhimBHYT'];					
						   ...
						   echo '<td style="border:solid 1px #000000 !important;text-align:center; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['soluong'],"0",",",".").'</td>';

						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['DonGiaBV'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.$tylevienphi.'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['GiaBaoHiem'],"0",",",".").'</td>';
						   ...
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['thanhtien'],"0",",",".").'</td>';

						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['thanhtien'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['ThanhTienBaoHiem'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['nguoibenh'],"0",",",".").'</td>'; 
							echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;"></td>'; 
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px;">'.number_format($bhyt[$i]['ThanhTienChiTraBV'],"0",",",".").'</td>';
						}
					}
				  ...
				  echo '</tr>';
				   ...
				   echo '<tr style=" border:1px solid #000;">';
				   		   ...
				   		   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[count($bhyt)-1]['thanhtien'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[count($bhyt)-1]['thanhtien'],"0",",",".").'</td>';

						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[count($bhyt)-1]['ThanhTienBaoHiem'],"0",",",".").'</td>';
						   echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[count($bhyt)-1]['nguoibenh'],"0",",",".").'</td>'; 
						    echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;"></td>'; 
						    echo '<td style="border:solid 1px #000000 !important;text-align:right; padding-left: 2px; padding-right: 2px; font-weight: bold;">'.number_format($bhyt[count($bhyt)-1]['ThanhTienChiTraBV'],"0",",",".").'</td>'; 
				  echo '</tr>';
			  ?>
              </tbody>
...
Tổng chi phí đợt điều trị: <strong><?=number_format($bhyt[count($bhyt)-1]['thanhtien'],"0",",",".")?>đ</strong><br />
<label style="font-style: italic; display: inline-block; margin-bottom: 5px;">(Viết bằng chữ: <span id="sotien"></span>)</label><br />
Số tiền Quỹ BHYT thanh toán: <strong><?=number_format($bhyt[count($bhyt)-1]['ThanhTienBaoHiem'],"0",",",".")?>đ</strong> <label style="margin-left:100px;">Số tiền người bệnh trả: <strong><?=number_format($bhyt[count($bhyt)-1]['nguoibenh'],"0",",",".")?>đ</strong></label><br /> 
<?php
//if($sophimbhyt!=0){
...
<tr style="border:none" style="font-size:12px;">	
	...
	KẾ TOÁN VIỆN PHÍ<br />
	(ký,ghi rõ họ tên)<br /><br /><br /><br />
	<strong>Phạm Thị Dung</strong><br /><br />
	</td>
	<td style="text-align:center;border:none; vertical-align: top;"><br />
	Ngày.....tháng.....năm.....<br />
	GIÁM ĐỊNH BHYT<br />
