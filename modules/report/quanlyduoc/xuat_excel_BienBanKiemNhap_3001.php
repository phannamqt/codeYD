...
<div id="wrapper">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" style="width:800px;margin-top:5px; font-size:24px; font-family:Arial, Helvetica, sans-serif">
    	<tr>
        	<td width="30%" colspan="5" align="center" style="font-size:22px; font-weight:bold">SỞ Y TẾ TP ĐÀ NẴNG</td>
        	<td width="20%" colspan="3" align="center" style="font-size:22px; font-weight:bold">&nbsp;</td>
        	<td colspan="3" align="center" style="font-size:22px; font-weight:bold">CỘNG HÒA XÃ HỘI CHỦ NGHĨ VIỆT NAM</td>
            
        </tr>
    	<tr>
    	  <td colspan="5" align="center" style="font-size:22px; font-weight:bold"><?php echo $_SESSION["com"]["TenBenhVien"]?></td>
        ...
        <tr>
        	<td colspan="11" align="center" style="font-size:28px; font-weight:bold">BIÊN BẢN KIỂM NHẬP THUỐC / VẬT TƯ, HÓA CHẤT</td>
        </tr>
        <tr>
        	<td colspan="11" align="left" style="font-size:22px;">
				Hôm nay, ngày  
                <?php echo $tam[0]["NgayNhapKho"]->format("d")." tháng " . $tam[0]["NgayNhapKho"]->format("m")." năm " .  $tam[0]["NgayNhapKho"]->format("Y"); ?>
             tại Khoa dược <?php echo $_SESSION["com"]["TenBenhVien"]?> Đà Nẵng, chúng tôi gồm các thành viên hội đồng kiểm nhập hàng sau,<br /> gồm các khoản cụ thể:</td>
        </tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" style="width:800px;margin-top:35px; font-size:24px; font-family:Arial, Helvetica, sans-serif">
  ...
  <tr>
    <td colspan="2" align="center"><em><br /><strong>Trần Hùng</strong></em></td>
    <td colspan="2" align="center"><em><br /><strong>Nguyễn Nữ Bảo Chi</strong></em></td>
    <td colspan="2" align="center"><em><br /><strong>Nguyễn Thị Ly</strong></em></td>
    <td align="center">&nbsp;</td>
    <td colspan="2" align="center"><em><br /><strong>Nguyễn Thị Bích Ngọc</strong></em></td>
    <td align="center">&nbsp;</td>
  </tr>
</table>
</body>
