   ...
   <tbody>
	...
	for($i=0;$i<=count($thongtinluotkham)-1;$i++){
		...
		*/
		...
		{
		 echo('	<tr style=" font-size:11px; width:90%;font-family:Tahoma, Geneva, sans-serif;font-style:italic" height="36.7px">
		<td style="padding-top:0px;" valign="bottom" width="20px!important" ><img style=" max-width: 19px;width:19px;" src="images/logo_den.png" /></td>
		<td  width="255px!important">Bn: '. $thongtinluotkham[0]["tenbenhnhan"].', '.$thangtuoi.' , ID: '.$thongtinluotkham[0]["MaBenhNhan"].' 	</td>
			
		<td>BS:'.$thongtinluotkham[0]["bacsi"].'</td>
    </tr>
	 <tr  style="font-size:9px; width:100%;font-family:Tahoma, Geneva, sans-serif;font-style:italic" height="3px">
            <td colspan="2" style=" border-bottom:1px solid #000; padding-bottom:3px;">
                 Ngày cấp thuốc: '.$thongtinluotkham[0]["NgayXuat"].'
            </td>  
			<td style=" border-bottom:1px solid #000; padding-right:8px" >N.x.thuốc:'.$thongtinluotkham[0]["ngxthuoc"].'</td>      
       </tr>
	');
	 echo('  <tr style="padding-left:15px; font-size:13px; width:100%;font-family:Tahoma, Geneva, sans-serif; font-weight:bold " height="20px">
            <td colspan="2">
        ...
        <tr  style="font-size:11px; width:100%;font-family:Tahoma, Geneva, sans-serif;">
            <td colspan="3" style="width:100%; padding-bottom:2px;" height="16px">
                '.$thongtinluotkham[$i]["CachDung"].'
            </td>        
       </tr>
        <tr  style="font-size:10px; width:100%;font-family:Tahoma, Geneva, sans-serif;page-break-after:always">
            <td colspan="3" style="width: 100%; padding-bottom: 1px; text-align: center; font-style: italic; border-top: 1px dashed #000; padding-top: 2px; padding-right:4px;" height="13px">
                Mua FAMILY-BẢO VIỆT Insurance được chi trả 80 triệu - 400 triệu VNĐ
            </td>        
       </tr> ');
	   $y++;
	   }}
