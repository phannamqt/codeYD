...
$store_name="{call [KHODUOC_TONHIENTAI_THAMSO_NEW_3](?,?,?)}";
...
<th width="70px">SL tồn 12.2014 </th>
<th width="70px">TT tồn 12.2014</th>
<th width="70px">SL tồn 12.2016 </th>
<th width="70px">TT tồn 12.2016 </th>
<th width="70px">SL tồn 12.2017 </th>
<th width="70px">TT tồn 12.2017 </th>
...
foreach($thuoc as $row){
	...
	<td style="text-align:left"><?=$row['SL_TonT12_2014']?></td>
	<td style="text-align:left"><?=$row['TT_TD_12_2014']?></td>
	<td style="text-align:left"><?= isset($row['SL_TON_2016'])?  $row['SL_TON_2016'] : 0;//$row['SL_TON_2016']?></td>
	<td style="text-align:left"><?= isset($row['TT_TON_2016'])?  $row['TT_TON_2016'] : 0;//$row['TT_TON_2016']?></td>
	<td style="text-align:left"><?= isset($row['SL_TON_2017'])?  $row['SL_TON_2017'] : 0;//$row['SL_TON_2017']?></td>
	<td style="text-align:left"><?= isset($row['TT_TON_2017'])?  $row['TT_TON_2017'] : 0;?></td>
	<td style="text-align:left"><?=$row['SL_N']?></td>
	<td style="text-align:left"><?=$row['TT_N']?></td>
	<td style="text-align:left"><?=$row['SL_X']?></td>
	<td style="text-align:left"><?=$row['DonGiaMua']*$row['SL_X']?></td>
	<td style="text-align:left" bgcolor="#D5EAFF"><?=$row['TonHienTai']?></td>
	<td style="text-align:left" bgcolor="#D5EAFA"><?=$row['TT_TD_12_2014']+$row['TT_N']-$row['DonGiaMua']*$row['SL_X']?></td>
	...
	<td style="text-align:left"><?=$row['SL_X_TIEUHAONOIBO']?></td>
	<td style="text-align:left"><?=$row['TT_X_TIEUHAONOIBO']?></td>
