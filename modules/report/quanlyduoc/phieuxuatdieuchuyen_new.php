...
<?php
	...
	if(isset($_GET['maphieugop']) && $_GET['maphieugop']>0){
     ...
     <div id="page_1" class="page" style="page-break-after: always; padding-left: 10px; padding-top:5px">
        ...
        <table id="bang_1" width="700px" cellpadding="0" cellspacing="0" border="1">
          <tr>
            ...
            <th width="50px">Mã</th>
            <th width="400px">Tên thuốc - VTYT</th>
			  	...
			  	foreach($thuoc as $row){
					...
					?>
					 <tr>
						...
						<td style="text-align:right; padding-right:3px;"><?=$row['SoLuong']?></td>
					  </tr>
					<?php
					}
		    ...
		    <table width="700px" border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td colspan="4" style="text-align:right; font-style:italic">Ngày in: <?php
						//$date = $thongtin[0]['NgaygioTao']->format("H:i ".$_SESSION["config_system"]["ngaythang"]);///date("H:i ".$_SESSION["config_system"]["ngaythang"]);
						echo date("H:i ".$_SESSION["config_system"]["ngaythang"]);
						?><br><br></td>
			  </tr>
			  <tr>
