...
<?php
	...
	if($_GET['maphieugop']>0){
		...
		$store_name2="{call GD2_GetPhieuXuatDieuChuyenByID_PhieuXuatDieuChuyen_Gop_DaXuat(?)}";
	}else{
		$params = array($_GET['idphieu']);
		$store_name="{call GD2_GetAllPhieuXuatDieuChuyenByID_Phieu(?)}";
		$params2 = array($_GET['idphieu']);
		$store_name2="{call GD2_GetPhieuXuatDieuChuyenByID_PhieuXuatDieuChuyen_DaXuat(?)}";
	}
