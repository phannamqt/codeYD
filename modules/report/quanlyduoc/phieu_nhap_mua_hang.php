...
<div align="center" >	 
    <div class="header">
          ...
          <div id="center">
          	<div style="font-size:20px">PHIẾU NHẬP KHO</div>
            <div><label style="font-style:italic">Ngày </label><label style="font-style:italic"><?php $parts = explode('-', $_POST["NgayNhapKho"]); echo $parts[0]?></label><label style="font-style:italic"> tháng </label><label style="font-style:italic"><?php echo $parts[1]?>  </label><label style="font-style:italic"> năm </label><label style="font-style:italic"><?php echo $parts[2]?></label></div>
            <div style="font-size:13px;">
            <label class="inhoa">Mã PNK: </label><label><?php echo ($_POST["MaPhieu"])?></label>						
            </div>
          </div>
     </div>
     <table cellpadding="0" cellspacing="0" border="0" style="width:750px; border:none">
         <tr>
             ...
             <td style="border:none"><input type="text" id="ngiaodich" style="width:640px; border:none; border-bottom:1px dotted #000" readonly="readonly"  						value=""/></td>
         </tr>
         <tr>
             <td style="width:93px;border:none">Nhà cung cấp</td>
             <td style="width:3px;border:none">:</td>
             <td style="border:none"> <input type="text" id="ncc" style="width:640px; border:none; border-bottom:1px dotted #000" readonly="readonly"  value=""/>	 </td>
         </tr>
         <tr>
             <td style="width:93px;border:none">Địa chỉ</td>
             <td style="width:3px;border:none">:</td>
             <td style="border:none"> <input type="text" style="width:640px; border:none; border-bottom:1px dotted #000" readonly="readonly"  value="xxx"/>	 </td>
         </tr>
          <tr>
             <td style="width:93px;border:none">Nhập vào kho</td>
             <td style="width:3px;border:none">:</td>
             <td style="border:none"> <input type="text" style="width:640px; border:none; border-bottom:1px dotted #000" readonly="readonly"  value="<?php echo ($_POST["ID_Kho"])?>"/>	 </td>
         </tr>
         <tr>
             <td style="width:93px;border:none">Loại nhập</td>
             <td style="width:3px;border:none">:</td>
             <td style="border:none"> <input type="text" style="width:640px; border:none; border-bottom:1px dotted #000" readonly="readonly"  value="<?php echo ($_POST["ID_NhapXuat"])?>"/>	 </td>
         </tr>
         <tr>
             <td style="width:93px;border:none">Ngày lập phiếu</td>
             <td style="width:3px;border:none">:</td>
             <td style="border:none"> <input type="text" style="width:640px; border:none; border-bottom:1px dotted #000" readonly="readonly"  value="<?php echo ($_POST["NgayLapPhieu"])?>"/>	 </td>
         </tr>
         <tr>
             <td style="width:93px;border:none">Ghi chú</td>
             <td style="width:3px;border:none">:</td>
             <td style="border:none"> <input type="text" style="width:640px; border:none; border-bottom:1px dotted #000" readonly="readonly"  value="<?php echo ($_POST["GhiChu"])?>"/>	 </td>
         </tr>
     </table>
	 ...
	 <table  style="width:750px" border="0" cellpadding="0" cellspacing="0">
     	<tr>
            ...
            <th align="center" style="width:333px"><label class="inhoa">Tên biệt dược</label></th>
     ...
     font-size:14px" name="" id="tongtien" value="<?php echo $total?>" /></div>
