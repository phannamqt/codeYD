...
<table width="100%" border="1">
  <tr>
    ...
    <td rowspan="4" align="center" valign="middle">ID_Thuoc</td>
    ...
    <td rowspan="4" align="center" valign="middle">Hãng sản xuất</td>
    <td rowspan="4" align="center" valign="middle">Nước sản xuất</td>
    <td rowspan="4" align="center" valign="middle">Nhà cung cấp</td>
 
    <td rowspan="4" align="center" valign="middle">Giá nhập</td>
    <td rowspan="4" align="center" valign="middle">Giá sau thuế </td>
    <td colspan="2" align="center" valign="middle">Tồn   đầu kỳ</td>
    <td colspan="2" align="center" valign="middle">Nhập trong kỳ</td>
    <td colspan="20" align="center" valign="middle">Xuất trong kỳ</td>
  ...
  <tr>
    ...
    <td rowspan="3" align="center" valign="middle">Số lượng</td>
    <td rowspan="3" align="center" valign="middle">Thành tiền</td>
    <td colspan="10" align="center" valign="middle">BHYT(A)</td>
 ...
 <td rowspan="3" align="center" valign="middle">Số lượng</td>
  ...
  <tr>
    <td colspan="4" align="center" valign="middle">Ngoại trú(1)</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle">Số lượng(Hỗ trợ)</td>
    <td align="center" valign="middle">Thành tiền(Hỗ trợ)</td>
    <td align="center" valign="middle">Số lượng</td>
    <td align="center" valign="middle">Thành tiền</td>
    <td align="center" valign="middle">Số lượng</td>
    <td align="center" valign="middle">Thành tiền</td>
...
<!-- //  CoSoTuTruc         SL_X_TrongKy_TieuHao_VP -->
            ...
            <td style="text-align:left"><?=$row['TenNhomThuoc']?></td>
						...
						<td style="text-align:left"><?=$row['TenNhaSanXuat']?></td>
						<td style="text-align:left"><?=$row['TenNuocSanXuat']?></td>
						<td style="text-align:left"><?=$row['TenNCC']?></td>
						
					
						<td style="text-align:left"><?=$row['GiaNhap']?></td>
                        <td style="text-align:left"><?=$row['GiaSauThue']?></td>
            ...
            <td  ><?=$row['SL_X_TrongKy_BHYT_NgoaiTru_HoTro']?></td>
            <td  ><?=$row['TT_X_TrongKy_BHYT_NgoaiTru_HoTro']?></td>
            ...
            <td  ><?=$row['TT_X_TrongKy_NgoaiTru_VP']+$row['TT_X_TrongKy_NoiTru_VP']+$row['TT_X_TrongKy_TieuHao_VP']?></td>
            <td  ><?=$row['SL_TongXuat_TrongKy_VP']+$row['SL_TongXuat_TrongKy']?></td>
            <td  ><?=$row['TT_X_TrongKy_NgoaiTru_VP']+$row['TT_X_TrongKy_NoiTru_VP']+$row['TT_X_TrongKy_TieuHao_VP']+$row['TT_TongXuat_TrongKy']?></td>
