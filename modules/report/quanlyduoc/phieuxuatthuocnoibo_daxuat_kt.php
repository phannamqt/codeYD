...
<?php
	...
	$store_name="{call GD2_GetAllPhieuXuatNoiBoByID_PhieuXuatNoiBo_Thanh(?)}";//tao bien khai bao store
     ...
     <div id="page_1" class="page" style="page-break-after: always; padding-left: 10px; padding-top:5px">
        ...
        <table id="bang_1" width="700px" cellpadding="0" cellspacing="0" border="1">
          <tr>
            ...
            <th width="50px">Mã</th>
            <th width="300px">Tên thuốc - VTYT</th>
		    ...
		    <table width="700px" border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td colspan="4" style="text-align:right; font-style:italic">Ngày in: <?php
						...
						//echo "16:00 30/09/16";
						//echo $date;
						if(isset($_GET['ngay_edit']) && !empty($_GET['ngay_edit'])){
						echo $_GET['ngay_edit'];
						}else{

						echo $thongtin[0]['NgaygioTao']->format("H:i ".$_SESSION["config_system"]["ngaythang"]);
						}
						?><br><br></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td><center><img id="bs_chandoan" width="100"/></div></center></td>
			  </tr>
			  <tr>
			    <td>&nbsp;</td>
				<td>&nbsp;</td>
				...
				<td style="text-align:center"> 
					...
					<strong><?=$thongtin[0]['HoTenNhanVien_']?></strong>
				</td>
			  </tr>
		</table>
	 </div>
...
<script type="text/javascript">
	$(document).ready(function(e) { //180
		if(1==<?= $_GET['chuky']?>){
            load_sign('<?=$thongtin[0]["HinhChuKy_"]?>',"bs_chandoan");
        }
	 print_preview();
	});
</script>
