...
<?php  
function covert_tien($input){
    $nombre_format_francais = number_format($input, 2, ',', '.');
...
<table  border="1" cellpadding="0" cellspacing="0" align="center"  style="font-size:20px;width:680px;margin-top:5px; font-family:'Arial', Gadget, sans-serif">
        ...
        foreach ($tam as $row) {//duyet toan bo mang tra ve
			...
			$tongtien=$tongtien+(float)$row["TTvat"];
            echo "<tr>";
			...
			echo '<td align="right">'.covert_tien((float)$row["DonGia"])."</td>";
			echo '<td align="right">'.(float)$row["PhanTramVat"]."</td>";
			echo '<td align="right">'.covert_tien((float)$row["TTvat"])."</td>";
			...
			if(count($tam)==$stt){
				...
				echo '<td align="left"></td>';
				echo '<td align="left"></td>';
				echo '<td align="right" style="font-weight:bold">'.covert_tien((float)$tongtien)."</td>";
				echo '<td align="left"></td>';
				echo '<td align="left"></td>';
				echo '<td align="left"></td>';
				echo '<td align="left"></td>';
...
<table border="0" cellpadding="0" cellspacing="0" align="center" style="width:680px;margin-top:35px; font-size:24px; font-family:Arial, Helvetica, sans-serif">
  <tr>
    <td width="5%" rowspan="5" align="center"><em><br /><br /><br />
    </em></td>
    <td colspan="2" align="center" ><strong>Kế Toán Trưởng</strong></td>
    <td colspan="3" align="center"><strong>Trưởng Khoa Dược</strong></td>
    <td colspan="4" width="20%" align="center"><strong>HC Dược/mua hàng</strong></td>
  ...
  <tr>
    <td colspan="2" align="center"><em><br /><br /><br /><strong> </strong>
    </em></td>
    <td colspan="3" align="center"><em><br /><br /><br /><strong> </strong></em></td>
    <td colspan="4" align="center"><em><br /><br /><br /><strong> </strong></em></td>
