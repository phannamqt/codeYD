...
<body>
  ...
  <table border="1" cellpadding="0" cellspacing="0" align="center" style="width:2000px;margin-top:5px"">
    	<tr height="30">
            <th width="29">STT</th>
            <th width="500">Tên công ty cung ứng</th>
            <th width="150">Nợ đầu kỳ</th>
            <th width="150">Nhập trong kỳ</th>
            <th width="150">Trả trong kỳ</th>
            <th width="150">Nợ cuối kỳ</th>
      </tr>
         <?php
		$stt=1;
		$NoDauKy=0;
		...
		?>
    <tr height="30">
         	<td width="29" align="center"><?=$stt?></td>
            <td width="500" align="left"><?=$row['TenNCC']?></td>
            <td width="150" align="right"><?=number_format($row['NoDauKy'],"0",",",".")?></td>
            <td width="150" align="right"><?=number_format($row['NhapTrongKy'],"0",",",".")?></td>
            <td width="150" align="right"><?=number_format($row['TraTrongKy'],"0",",",".")?></td>
            <td width="150" align="right"><?=number_format($row['NoCuoiKy'],"0",",",".")?></td>
      </tr>
      <?php
			$stt++;
		}
