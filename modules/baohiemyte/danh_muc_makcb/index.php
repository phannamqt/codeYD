...
function create_grid(){	
		...
		datatype: "json",	
		colNames:['Mã','Tên KCB Ban Đầu','Mã Tĩnh'],
		colModel:[
			{name:'Ma_KCB',index:'Ma_KCB',search:true, width:"20%", editable:true,align:'left',hidden:false,edittype:"text",formoptions:{rowpos:1, colpos :1}}, 
				 
			{name:'Ten_kcb',index:'Ten_kcb',search:true, width:"60%", editable:true,align:'left',hidden:false,edittype:"textarea",formoptions:{rowpos:2, colpos :1}}, 
			{name:'MaTinh',index:'MaTinh',search:true, width:"20%", editable:true,align:'left',hidden:false,edittype:"text",formoptions:{rowpos:3, colpos :1}}, 
		],
			loadonce: true,
            scroll: false,
            modal: true,
		...
		caption: "Danh mục mã khám chữa bệnh"
	});	
