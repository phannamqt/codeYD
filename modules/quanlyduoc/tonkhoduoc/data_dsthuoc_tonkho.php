<?php
	...
	$params = array($_GET["idkho"],convert_date($_GET['fromdate']),convert_date($_GET['todate']).' 23:59:59',0,null);//tao param cho store
	//$store_name="{call [KHODUOC_TONHIENTAI_THAMSO_NEW](?,?,?)}";//tao bien khai bao store dieukienloc
	// '2019-5-4','2019-5-28 23:59:59',2,0
...
foreach ($tam as $row) {//duyet toan bo mang tra ve
   ...
   0,// $row["SL_TonT12_2014"],
    ...
    ,$row["TonHienTai"],
	$row["SoTonChinhXac"],
	$row["SoTonChinhXac"]-$row["TonHienTai"],
	$row["CountLoHD_N"],
	$row["CountLoHD_X"],
	0,
	0,//$row["CoSoTuTruc"]
	0,//,$row["TonThucTe"] ,CountLoHD_N
