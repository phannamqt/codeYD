  ...
  <option value="7">Báo cáo tổng hợp thuốc trả lại theo tháng</option>
    ...
    <div id="panel_main" >  
		<div id="main_top">
            ...
            <input type="button" id" value="Xem theo lô hạn dùng" />
            <input type="button" id="xuat_excel" value="Excel" />
            <input type="button" id="xuatexcel" value="Excel_option" />
...
//alert($('#kho').val());
    ...
    alert('d');
        /*if(window.n_action==1){
								  window.open("pages.php?module=report&view=quanlyduoc&action=xuat_excel_baocaotonghopxuatnhapton&type=excel&theonhacungcap=false&from_day="+$("#tungay").val()+"&to_day="+$("#denngay").val()+"&tenkho="+$("#makho1").val()+"&ten_kho="+$("#makho").val()+"&n_order= ORDER BY TenBietDuoc");
							  }else{
								  window.open("pages.php?module=report&view=quanlyduoc&action=xuat_excel_baocaotonghopxuatnhapton&type=excel&theonhacungcap=true&from_day="+$("#tungay").val()+"&to_day="+$("#denngay").val()+"&tenkho="+$("#makho1").val()+"&ten_kho="+$("#makho").val()+"&idncc="+window.idncc+"&n_order=");
							  }*/
...
function create_grid() {
      mydata=[];
        $("#rowed3").jqGrid({
            data: mydata,
            datatype: "local",
            colNames: ['id_thuoc','Tên thuốc','ĐVT','Quy cách','Nhóm','Nhà cung cấp','Thuốc','Giá nhập cuối',
            'SL Tồn đầu 12_2104', 'SL nhập','Tiền nhập', 'SL xuất',
            'Tiền xuất','Xuất nội trú','Xuất ngoại trú','Xuất tiêu hao','Xuất điều chuyển', 'SL tồn','Tiền tồn','SL Tủ trực','SLTỒN THỰC TẾ','NhậpBH','TiềnnhậpBH','Xuất_Ngoạitrú_BH_BV','Tiền_Ngoạitrú_BH_BV','Xuất_Nộitrú_BH_BV','Tiền_Nộitrú_BH_BV',''],
            colModel: [
            {name: 'id_thuoc', index: 'id_thuoc',sortable: true, search: true, width: "5%", editable: false, align: 'left', hidden: true,classes:'abc'},
                ...
                {name: 'QuyCach', index: 'QuyCach',sortable: true, search: true, width: "3%", editable: false, align: 'left', hidden: false,classes:'abc'},
                ...
                {name: 'NCC', index: 'NCC',sortable: true, search: true, width: "20%", editable: false, align: 'left', hidden: false,classes:'abc'},
                {name: 'LaThuoc', index: 'LaThuoc', formatter: "checkbox",sortable: true, edittype: "checkbox", editoptions: {value: "1:0"},search: true, width: "3%", editable: false, align: 'left', hidden: false,classes:'abc'},
                {name: 'GiaCuoi',classes:'colored6' ,sorttype:'float',formatter:'currency',formatoptions:{ thousandsSeparator: ".", decimalPlaces: 0, prefix: ""}, index: 'GiaCuoi', sortable: true,search: true, width: "6%", editable: false, align: 'right', hidden: false},
				{name: 'SL_TonT12_2014', index: 'SL_TonT12_2014',sortable: true, search: true, width: "5%", editable: false, align: 'right', hidden: false},
				...
				{name:'TT_N',classes:'colored3',sorttype:'float' ,index:'TT_N',formatter:'currency',formatoptions:{ thousandsSeparator: ".", decimalPlaces: 0, prefix: ""}, width:"12%",sortable: true, editable:false,align:'right',hidden:false},
				...
				{name:'TT_X',classes:'colored3',sorttype:'float' ,index:'TT_X',formatter:'currency',formatoptions:{ thousandsSeparator: ".", decimalPlaces: 0, prefix: ""}, width:"10%",sortable: true, editable:false,align:'right',hidden:false},
				{name: 'SL_X_NOITRU',sorttype:'float' ,classes:'colored2', index: 'SL_X_NOITRU', sortable: true,search: true, width: "7%", editable: false, align: 'center', hidden: false},
				{name: 'SL_X_NGOAITRU',classes:'colored2', index: 'SL_X_NGOAITRU',sortable: true, search: true, width: "7%", editable: false, align: 'center', hidden: false},
				{name: 'SL_X_TIEUHAONOIBO',sorttype:'float' ,classes:'colored2', index: 'SL_X_TIEUHAONOIBO',sortable: true, search: true, width: "7%", editable: false, align: 'center', hidden: false},
				{name: 'SL_X_DIEUCHUYEN',sorttype:'float' ,classes:'colored2', index: 'SL_X_DIEUCHUYEN', sortable: true,search: true, width: "7%", editable: false, align: 'center', hidden: false},
				{name: 'TonHienTai',sorttype:'float' ,classes:'colored', index: 'TonHienTai',sortable: true, search: true, width: "5%", editable: false, align: 'right', hidden: false},
				{name:'TT_Ton',sorttype:'float' ,classes:'colored3',formatter:'currency',formatoptions:{ thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},index:'TT_Ton',sortable: true,width:"10%", editable:false,align:'right',hidden:false},
				{name: 'CoSoTuTruc',sorttype:'float' ,classes:'colored', index: 'CoSoTuTruc',sortable: true, search: true, width: "5%", editable: false, align: 'center', hidden: false},
				{name: 'TonThucTe',sorttype:'float' ,classes:'colored',sorttype:'float', index: 'TonThucTe',sortable: true, search: true, width: "7%", editable: false, align: 'center', hidden: false},
				{name: 'SL_N_BH',index: 'SL_N_BH',sorttype:'float' ,classes:'colored4', sortable: true, search: true, width: "5%", editable: false, align: 'center', hidden: false},
				{name: 'TT_N_BH',index: 'TT_N_BH',classes:'colored4',sorttype:'float',formatter:'currency',formatoptions:{ thousandsSeparator: ".", decimalPlaces: 0, prefix: ""}, sortable: true, search: true, width: "10%", editable: false, align: 'center', hidden: false},
				{name: 'SLX_NgoaiTru_BH',classes:'colored5',sorttype:'float', index: 'SLX_NgoaiTru_BH',sortable: true, search: true, width: "5%", editable: false, align: 'center', hidden: false},
				{name: 'TT_NgoaiTru_BH',classes:'colored5',formatter:'currency',formatoptions:{ thousandsSeparator: ".", decimalPlaces: 0, prefix: ""}, index: 'TT_NgoaiTru_BH',sortable: true, search: true, width: "10%", editable: false, align: 'center', hidden: false},
				{name: 'SLX_NoiTru_BH',sorttype:'float' ,classes:'colored5', index: 'SLX_NoiTru_BH',sortable: true, search: true, width: "5%", editable: false, align: 'center', hidden: false},
				{name: 'TT_NoiTru_BH',classes:'colored5',sorttype:'float',formatter:'currency',formatoptions:{ thousandsSeparator: ".", decimalPlaces: 0, prefix: ""}, index: 'TT_NoiTru_BH',sortable: true, search: true, width: "10%", editable: false, align: 'center', hidden: false},
            ...
            loadComplete: function(data) {
                ...
                for (i = 0; i < ids.length; i++) {
                    ...
                    var rowData = jQuery('#rowed3').getRowData(ids[i]);
                      //var ID_PLoaiKham  =rowData["MauBaoDong"];
