...
foreach ($tam as $row) {
    ...
    $responce->rows[$i]['cell']=array($row["TenGoc"],$row["TenNhomThuoc"],$row["MaThuoc"],$row["TenDayDu"],$row["TenNhaSanXuat"],$row["HoatChatChinh"],$row["SignNumber"],$row["TenDonViTinh"],$row["QuyCach"],$row["Giaban"]);
    $i++; 
}   
