...
jQuery(document).ready(function() {
  ...
  $("#baocao_excel,#taoluotkhamtudong,#inphieukskhangloat,#inphieukham,#chidinhtheogoikham,#inphieukskmotbn,#inchidinh,#baocao,#luu,#indiachi,#xuatexcel,#xuatexcelxh,#xuatexcel_phiTH,#xuatexcel_phiTH_nhom,#xuatexcel_xn,#xuatexcel_trangthaikham").button();
...
$("#chidinhtheogoikhamhangloat").click(function(){
  ...
  //alert(id_luotkhamP);  
      ...
      var selr2 = jQuery("#data_dotkham").jqGrid('getGridParam','selrow');
       var rowData = $("#rowed3").getRowData(selr);
           $.get('resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=controller&ac=chidinhgoikhamhangloat&id_kh_congty='+window._idcongty+'&id_goikham_congty='+window._idgoikhamcongty+'&id_luotkhamP='+id_luotkhamP).done(function(data){
            if(data=="")
            {
 ...
 /* $.post('resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=controller&ac=chidinhgoikhamhangloat&id_kh_congty='+window._idcongty+'&id_goikham_congty='+window._idgoikhamcongty,postData).done(function(data){
