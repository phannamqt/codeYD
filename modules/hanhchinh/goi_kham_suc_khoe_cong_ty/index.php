...
.frame_u78787878975f3{
	width:300px!important;
	text-align:center!important;alize;
	}
	height:auto;
	}
.viethoachucai{
...
jQuery(document).ready(function() {
  ...
  $("#baocao_excel,#excel_doanhthu_ksk,#taoluotkhamtudong,#inphieukskhangloat,#inphieukham,#chidinhtheogoikham,#inphieukskmotbn,#inchidinh,#baocao,#luu,#indiachi,#xuatexcel,#xuatexcelxh,#xuatexcel_phiTH,#xuatexcel_phiTH_nhom,#xuatexcel_xn,#xuatexcel_trangthaikham").button();
