...
$tam["Avatar"]=$thongtinbenhnhan[0]["Avatar"];
...
<table id="main_top" style="width:100%;" cellpadding="0" cellspacing="0">
	<tr>
		<td style="vertical-align:top;">
			<fieldset id="ttbenhnhan" style=" ">
			  <legend><?php lang('ttinbnhan')?></legend>
				<table width="592" height="364" border="0">
                  <tr>
                    <td><p align="right"><?php lang('maBN')?>:</p></td>
                    <td> <label id="mabn1" name="mabn1" class="hienthi" style="width:193px;margin-left:5px; font-weight:bold;" type="text"><?=$tam["MaBenhNhan"]?></label></td>
                    <td rowspan="7"> <img id="hinh_benhnhan" class="non_image" title="Click vào để cập nhật ảnh đại diện" style="border solid green 1px; width: 220px; height:178px;" src=""/>
                    <input type="hidden" id="view_avatar" name="view_avatar"> <button id="chon_anhdaidien" style="float: left; width: 195px; cursor: pointer;" title="Click vào để cập nhật ảnh đại diện">Chọn hình ảnh</button>
<button id="clear_avatar" style="float: left; width: 26px; height: 22px; border: 1px solid red; cursor: pointer; margin-top: 1px;" title="Xóa ảnh đại diện">
                  ...
                  <tr>
                    <td width="77"><div align="right">Họ tên:  </div></td>
                    <td width="278"> <input id="holot" name="holot" class="viet-hoa-chu-cai" type="text" value="<?=$tam["HoLotBenhNhan"]?>" lang="holot" style="width:150px;margin-left:5px"> <input id="tenbn" value="<?=$tam["TenBenhNhan"]?>" name="tenbn" lang="tenbn" class="viet-hoa-chu-cai" type="text" style="width:100px;"></td>
                  </tr>
                  <tr>
                    <td><div align="right">Giới tính: </div></td>
                    <td><input id="nam"   style="vertical-align: middle" lang="nam" type="radio" name="sex" value="0">Nam
		<input id="nu"   style="vertical-align: middle" lang="nu" type="radio" name="sex" value="1">Nữ</td>
                  </tr>
                  <tr>
                    <td><div align="right">Ngày sinh:</div></td>
                    <td><label for="ngaysinh"  style="width:110px;text-align:right">Ngày </label>
    ...
    <label id="thangtuoi"  for="thangtuoi" style="width:100px;text-align:left;margin-left:5px "></label>
	<input "<?=$tam["SoThangTuoi"]?>"  id="thangtuoi" maxlength="2" name="thangtuoi"  style="width:44px; display:none;" type="text">
	</td>
                  </tr>
                  <tr>
                    <td><div align="right">Địa chỉ:</div></td>
                    <td><input id="sonha" type="text" class="viet-hoa-chu-cai" value="<?=$tam["diachi"]?>" lang="sonha" name="sonha" style="width:260px;margin-left:5px"></td>
                  </tr>
                  <tr>
                    <td><div align="right">Xã phường:</div></td>
                    <td><input id="xaphuong" name="xaphuong" type="text" style="width:170px;margin-left:5px"></td>
                    
                  </tr>
                  <tr>
                    <td><div align="right">Quận huyện:</div></td>
                    <td> <input id="quanhuyen" name="quanhuyen" type="text" style="width:170px;margin-left:5px" ></td>
                   
                  <tr>
                    <td><div align="right">Tỉnh thành:</div></td>
                    <td> <input id="tinhthanh" name="tinhthanh" type="text" style="width:170px;margin-left:5px"></td>
					 <td rowspan="7" style="vertical-align:top;"><fieldset style=" ">
		<legend>Thông tin liên hệ</legend><table style="width:100%;" border="0"  cellpadding="0" cellspacing="0">
                      <tr>
                        <td>Họ tên:</td>
                        <td><input value="<?=$tam["TenNguoiLienHe"]?>"   name="nlh" id="nlh" type="text" style="width:120px;margin-left:5px"></td>
                      </tr>
                      <tr>
                        <td>Địa chỉ:</td>
                        <td><input value="<?=$tam["DiaChiNguoiLienHe"]?>" id="dc_nguoilh" name="dc_nguoilh" type="text" style="width:120px;margin-left:5px"></td>
                      </tr>
                      <tr>
                        <td>Điện thoại</td>
                        <td><input value="<?=$tam["DienThoaiNguoiLienHe"]?>" id="dt_nguoilh" name="dt_nguoilh" type="text" style="width:120px;margin-left:5px"></td>
                      </tr>
                      <tr>
                        <td>Quan hệ với BN:</td>
                        <td><input value="<?=$tam["QuanHeVoiBN"]?>" id="quanhebn" name="quanhebn" type="text" style="width:120px;margin-left:5px"></td>
                      </tr>
                    </table></fieldset></td>
                  </tr>
                  </tr>
                  <tr>
                    <td><div align="right">Quốc tịch:</div></td>
                    <td><select id="quoctich" name="quoctich" type="text" style="width:170px;margin-left:5px"></select> </td>
                  </tr>
                  <tr>
                    <td><div align="right">Điện thoại:</div></td>
                    <td><input id="dienthoai1" value="<?=$tam["dienthoai1"]?>" name="dienthoai1" lang="dienthoai1" type="text" style="width:120px;margin-left:5px"> - <input id="dienthoai2" value="<?=$tam["DienThoai2"]?>" name="dienthoai2" type="text" style="width:120px;"> </td>
                  </tr>
                  <tr>
                    <td><div align="right">Email:</div></td>
                    <td><input id="email" value="<?=$tam["email"]?>" name="email" type="text" style="width:260px;margin-left:5px"></td>
                  </tr>
                  <tr>
                    <td><div align="right">Nghề nghiệp:</div></td>
                    <td><select id="nghenghiep" name="nghenghiep"  type="text" style="width:190px;margin-left:5px"></select></td>
                  </tr>
                  <tr>
                    <td><div align="right">Nơi công tác</div></td>
                    <td> <input id="congty" name="congty" type="text" style="width:163px;margin-left:5px">
    <input id="congty1" name="congty1"  type="hidden" ></td>
                  </tr>
                  <tr>
                    <td><div align="right">Ghi chú: </div></td>
                    <td><textarea id="quanhe" name="quanhe"  type="text" style="width: 260px; margin-left: 5px ;"><?=$tam["QuanHeVoiBenhVien"]?></textarea></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>Số tiền nợ cuối:  <?php if(isset($_GET['oper']) && $_GET['oper']=='edit'){echo $nocu[0][0];}else{echo 0;}?> đ</td>
                    <td>
                    <a style="margin-left:0px;  margin-bottom:1px;" class="fm-button-icon-left" id="save_data" href="#"><?php lang('luu')?><span class="ui-icon ui-icon-cancel
"></span></a>

<a style="margin-left:0px;  margin-bottom:1px;" class=" " id="sua" href="#"><?php lang('sua')?></a></td>
                  </tr>
                </table>
			</fieldset>
		</td>
...
<table id="rowed4" style="display:none;"></table>
...
$(".viet-hoa-chu-cai").keyup(function(e){
	var input_text=$(this).val();
	$(this).val(viethoachucaidau(input_text));
	$(this).attr("viethoa",viethoachucaidau(input_text));
});
...
create_rowed3();
// create_rowed4();
$("#ttbenhnhan").height($(window).height()- 30);
$("#rowed3").setGridHeight($(window).height()- 130);
$("#rowed3").setGridWidth(($(window).width()/2));
...
$('#hinh_benhnhan').attr('src','data:image/jpeg;base64,<?=$tam["Avatar"]?>');
$('#view_avatar').val(<?php  echo "'".$tam["Avatar"]."'";?>);
...
function _init(input,data,id) {
  ...
  function create_rowed3(){
   ...
   $("#rowed3").jqGrid('filterToolbar', {searchOperators: false, searchOnEnter: false, defaultSearch: "cn"});
	 $("#rowed3").jqGrid('navGrid',"#prowed3",{add: false, edit: false,addtext:'Thêm BN[F3]',edittext:"<?php lang('sua')?>", del: false,refresh:false, search:false,closeAfterEdit: true,clearAfterAdd :true,closeOnEscape : true,
 });
   $("#rowed3").jqGrid('navButtonAdd', '#prowed3', {caption: "Tạo Lượt Khám", buttonicon: 'ui-icon-document-b',id : 'taoluotkham_rowed3',
...
*/
 ...
 function create_rowed4(){
   $("#rowed4").jqGrid({
    ...
    rowList:[],
    sortname: 'ID_Thuoc',
    height:(($(window).height()-$("#main_top").height()-365)).toFixed(0),
    width: (($(window).width()) / 100 * parseFloat(99)).toFixed(0),
    viewrecords: true,
    ignoreCase:true,
    shrinkToFit:true,
