<?php
	//	print_r($_POST);
		...
		//$_POST["holot"]=	iconv('UTF-8', 'UCS-2', $_POST["holot"]);
		//$_POST["tenbn"]=	iconv('UTF-8', 'UCS-2', $_POST["tenbn"]);
		//$_POST["sonha"]=	iconv('UTF-8', 'UCS-2', $_POST["sonha"]);
		//$_POST["nlh"]=	iconv('UTF-8', 'UCS-2', $_POST["nlh"]);
		...
		if(!isset($_POST["xaphuong_hidden"]) || $_POST["xaphuong_hidden"]=='' || $_POST["xaphuong_hidden"]==0){
			  $_POST["xaphuong_hidden"]=null;
		}
		
		if(!isset($_POST["quanhuyen_hidden"]) || $_POST["quanhuyen_hidden"]=='' || $_POST["quanhuyen_hidden"]==0){
			  $_POST["quanhuyen_hidden"]=null;
		 }
		 if(!isset($_POST["tinhthanh_hidden"]) || $_POST["tinhthanh_hidden"]=='' || $_POST["tinhthanh_hidden"]==0){
			  $_POST["tinhthanh_hidden"]=null;
		 }
		
		// print_r($_POST);
	$data= new SQLServer;
	if($_GET['oper']=='add'){
		$store_name="{call GD2_DM_benhnhan_add_new (?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,? ,?)}";
		$params = array(
		//$_POST["hinhbenhnhan"],
		$_POST["holot"],
		$_POST["tenbn"],
		...
		$_POST["xaphuong_hidden"],
		$_POST["quanhuyen_hidden"],
		$_POST["tinhthanh_hidden"],
		$_POST["quanhe"],
		$_POST["email"],
		$_POST["view_avatar"],
		...
		//print_r($params);
		$tam=$data->query( $store_name, $params);	 	
		...
		$store_name="{call GD2_DM_benhnhan_edit_new (?,?,?,?,? ,?,?,?,?,? ,?,?,?,?,? ,?,?,?,?,? ,?,?,?,?,?)}";
		$params = array(
		//$_POST["hinhbenhnhan"],
		$_GET["idbenhnhan"],
		$_POST["holot"],
