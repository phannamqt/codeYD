...
<body>
<iframe name="an_iframe"></iframe>
<div id="main_top1" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-resizable" style="width:750px;  box-shadow:none!important;  display: block;;z-index: 1 !important;" >
...
$(document).ready(function() {
	console.log(convertHexToString('5472e1baa76e205472c6b0c6a16e672056c4836e'))
	...
	//ekwyM2VEeDlPV25SWjBqQ3N4bkV1UzF5VXFTbDJUdXNpR2xGeElUaGMzOD06NDgxOTVfQlY6MTMxNTkzNTE2MDIxODcyODY5
	//3974094e-2047-4bea-9d0e-28571fdf3014
...
/*  	$('body').append('<form  action="https://gdbhyt.baohiemxahoi.gov.vn/ThongTuyenLSKCB/CheckMaThe" method="post" target="an_iframe"  id="postToIframe"></form>');
    
    $('#postToIframe').append('<input type="hidden" name="MaThe" value="DN4484812034525" />');
    $('#postToIframe').append('<input type="hidden" name="HoTen" value="Nguyễn Phạm Ngọc Trâm" />');
    $('#postToIframe').append('<input type="hidden" name="NgaySinh" value="31/03/1989" />');
    ...
    $('#postToIframe').submit().remove();;*/
     ...
     /*   	$.ajax({
  		    ...
  		    /*var xhttp =  new XMLHttpRequest({mozSystem: true,mozAnon: true});
			...
			xhttp.open("POST", 'https://gdbhyt.baohiemxahoi.gov.vn/ThongTuyenLSKCB/CheckMaThe', true);
			xhttp.send();*/
        ...
        if (jwerty.is("ctrl+z",e)) {
        	$.ajax({
	  		...
	  		data:{username: '48195_BV',
	  				password:'fd16b54a98681877301e32b0efeb87ae' ,
	  				maThe: 'DN4484813034939',
					hoTen: 'Trần Trương Văn',
					ngaySinh: '04/02/1989',
					gioiTinh: '1',
					maCSKCB: '48195',		
				},
        ...
        if (jwerty.is("ctrl+x",e)) {
        	$.ajax({
	  		type: 'POST',
	  		async : false,
	  		url: 'http://egw.baohiemxahoi.gov.vn/api/egw/nhanLichSuKCB&token=ei96Qi90NEN5WXE5bk94a2IzRmFla2swL1dkeWYwSzRDQWtyZ0F5SUhPQT06NDgxOTVfQlY6MTMxNTkzNTI3NDk5NDY5NjA2&id_token=24d6062b-5058-4d27-b347-b1ee80d1198d&username=48195_BV&password=bb35ecb6594507c47d64f2e4c9fe8609',
	  		data:{  'maThe': 'DN4484813034939',
					'hoTen': 'TRẦN TRƯƠNG VĂN',
					'ngaySinh': '04/02/1989',
					'gioiTinh': 1,
					'maCSKCB': '48195',
...
function luu(){
	$('#thuchien').click(function(){	
		...
		if($("#phanloai_hidden").val()==''){
			...
			window.datatosend+=',"GhiChuTrieuChung":'+JSON.stringify($('#GhiChuTrieuChung').val())+'';	
...
function makeCorsRequest() {
  ...
  var url = 'https://gdbhyt.baohiemxahoi.gov.vn/ThongTuyenLSKCB';
