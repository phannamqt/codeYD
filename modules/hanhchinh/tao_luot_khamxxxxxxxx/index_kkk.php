	...
	$('#thuchien').click(function(){	
		...
		if($("#phanloai_hidden").val()==''){
			...
			if(window.id_bhyt==0 && $('#doituong_hidden').val()=='BHYT'){
				...
				// kiemr tra xem có trong cấu hình hay chưa
			    $.ajax({
        ...
        data: {
        	...
        	if(data==0){
        		var open_tab = confirm('Vui lòng chọn chuyên khoa đúng với phân loại khám\ntruy cập đường dẫn http://192.168.1.15:81/forum/index.php?topic=4796.10 để xem hướng dẫn')
        		if(open_tab){
