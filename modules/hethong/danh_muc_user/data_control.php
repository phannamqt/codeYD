...
$store_name="{call GD2_DM_NhomQuyen_SelectAll()}";//tao bien khai bao store
...
foreach ($tam as $row) {//duyet toan bo mang tra ve
    $responce->rows[$i]['id']=$row["ID_NhomQuyen"];
    $responce->rows[$i]['cell']=array($row["TenNhomQuyen"],$row["MoTa"],);
