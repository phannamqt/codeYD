...
switch ($_GET["oper"]) {
    ...
    case "luu1":
        luu1("GD2_Physio_kham_update_new");
        break;
    case "luu2":
...
function luu1($store_name){
        $chuoi1='(?,?,?,?,?,?,?,?,?)';
        $bien1=  array(($_POST["BSChanDoan"]),($_POST["NgayGioChanDoan"]),($_POST["ChanDoan"]),($_POST["MoTa"]),($_POST['KetLuan']),($_POST['ID_Kham']),($_POST['ID_TrangThai']),($_POST["NguoiThucHien"]),$_SESSION["user"]["id_user"]);
...
//print_r($_POST['data']);
  ...
  $store_name2="{call GD2_Physio_kham_update_new_by_id_kham(?)}";//tao bien khai bao store
