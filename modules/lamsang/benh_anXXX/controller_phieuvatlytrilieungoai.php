...
if($_POST['ngayravien']==''){
		$_POST['ngayravien']=null;
	}else{
		$_POST['ngayravien']=convert_date($_POST['ngayravien']);
	}
$data= new SQLServer;
$store_name="{call GD2_PhieuVLTLNgoai_Insert_New(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";	
...
$params    = array (
					...
					$_POST['vaophongkham'],
					$_POST['bsdieutri'],
					$_POST['ICD_RaVienBenhChinh_hidden'],
					$_POST['CD_RaVienBenhChinh'],
					$_POST['ICD_BenhKemTheo_hidden'],
					$_POST['CD_BenhKemTheo'],
					$_POST['chuy'],
					0,
					$_POST['chuandoanvaovien'],
					
					$_POST['PhuongPhapDieuTri'],
					$_POST['TinhTrangRaVien'],
					$_POST['HuongDieuTri'],
					$_POST['ngayravien'],
