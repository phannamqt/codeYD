...
<body>
    ...
    <div id="panel_main" >
        <div class="left_col ui-widget-content ui-layout-center">
            ...
            <a id='DShuyxephang' class="fm-button ui-state-default ui-corner-all " style="margin-top:-1px;vertical-align:top;width:110px;height:14px;display:none"  >Ds Hủy xếp hàng</a>
    ...
    $("#rowed3").jqGrid({
        ...
        datatype: "jsonstring",
            colNames: ['LuotKham', '<?php get_text1("maBN") ?>', '<?php get_text1("hoten") ?>',
                ...
                'Yêu cầu', 'BS trước', 'G.chú', 'N.Dung TK', 'Trạng thái', 'Sansang', 'NotesStatus', 'ID_BenhNhan','ID_PhongKhamVatLy','Gọi loa','MaYTe'],
            colModel: [
    ...
    $("#rowed4").jqGrid({
        ...
        datatype: "jsonstring",
            colNames: ['LuotKham', '<?php get_text1("maBN") ?>', '<?php get_text1("hoten") ?>', '<?php get_text1("tuoi") ?>',
                ...
                '<?php get_text("BsKham") ?>', 'Ghi chú', 'HoanTatHoSo', 'Trạng thái', 'Sẵn sàng', 'NotesStatus', 'ID_BenhNhan','Đối tượng','Gọi loa','MaYTe'],
            colModel: [
                ...
                {name: 'LoaiDoiTuongKham', index: 'LoaiDoiTuongKham', search: true, width: "1%", editable: false, align: 'left', hidden: false},
				 {name: 'GoiLoa', index: 'GoiLoa', width: "1%", hidden: false, search: false},
				{name: 'MaYTe', index: 'MaYTe', width: "0%", hidden: true},
            ],
			hidegrid: false,
            loadonce: true,
