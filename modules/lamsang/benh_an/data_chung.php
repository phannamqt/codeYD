...
echo 'T.khám: <strong>'.number_format(round($tam[0]['PhiThucHien'])).'</strong>, T.thuốc: <strong>'.number_format(round($tam[0]['tienthuoc']), 0, '', '.').'</strong>, Tổng: <strong>'.number_format(round($tam[0]['PhiThucHien'])+round($tam[0]['tienthuoc']), 0, '', '.').'</strong>, BH trả: <strong>'.number_format((round($tam[0]['ThanhTienBaoHiem'])+round($tam[0]['thuocbh'])), 0, '', '.').'</strong>, BN trả: <strong>'.number_format((round($tam[0]['PhiThucHien'])+round($tam[0]['tienthuoc']))-(round($tam[0]['ThanhTienBaoHiem'])+round($tam[0]['thuocbh'])), 0, '', '.').'</strong>';
