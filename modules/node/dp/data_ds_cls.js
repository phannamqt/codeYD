			...
			for(var i=0;i<recordsets.length;i++){
				...
				if(data==''){
					if(mangtam['ID_TrangThai']=='DangCho'){
						...
						chuoi1+=JSON.stringify(mangtam["SoPhieuKhamGoiLoa"])+']},';
					}				
					if(mangtam['ID_TrangThai']=='DangKham' || mangtam['ID_TrangThai']=='DaThucHien' || mangtam['ID_TrangThai']=='DaLayBenhPham' ){
						...
						chuoi2+=JSON.stringify(mangtam["SoPhieuKhamGoiLoa"])+']},';
					}
					if(mangtam['ID_TrangThai']=='Xong'){
						...
						chuoi3+=JSON.stringify(mangtam["SoPhieuKhamGoiLoa"])+']},';
					}
					if(mangtam['ID_TrangThai']=='Xong'){
						...
						chuoi4+=JSON.stringify(mangtam["IsDichVuCC"])+',';
						chuoi4+=JSON.stringify(mangtam["SoPhieuKhamGoiLoa"])+']},';
					}
				}else{
...
sql.connect(config, function(err) {
	...
	var chuoi3='';
	var chuoi4='';
	request.execute('GD2_LayDSXepHangCanLamSang_GroupXetNghiem_soc_test', function(err, recordsets, returnValue) {   
		count=1;
		console.log(count);
