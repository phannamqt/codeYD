...
function create_grid(){	
		...
		datatype: "json",	
		colNames:['Id','<?php get_text("tenphongban")?>','<?php get_text("thuocphongban")?>','<?php get_text1("mota")?>','<?php get_text("dienthoai")?>','Phòng chuyên môn','<?php get_text("khuvuc")?>','<?php get_text("congty")?>','<?php get_text1("sudung")?>','K.Cách','Tầng','Tầng','Phòng chuyên môn','Phòng CM'],
		colModel:[
			...
			{name:'ID_PhongBanCha',index:'ID_PhongBanCha',search:true, width:"15%", editable:false,align:'left',formatter:"select",edittype:"select",hidden:true,editoptions:{value:phongban},formoptions:{rowpos:1 , colpos :1}},		 
			{name:'MoTa',index:'MoTa',search:true, width:"10%", editable:true,align:'left',hidden:false,edittype:"textarea",formoptions:{rowpos:3, colpos :1}}, 
			{name:'DienThoai',index:'DienThoai',search:true, width:"10%", editable:true,align:'left',hidden:false,edittype:"text",formoptions:{rowpos:2, colpos :1}}, 
			...
			{name:'ID_KhuVuc',index:'ID_KhuVuc',search:true, width:"10%", editable:false,align:'left',edittype:"select",formatter:"select",hidden:false,editoptions:{value:khuvuc},formoptions:{rowpos:2, colpos :1},hidden:true}, 
			{name:'ID_CongTy',index:'ID_CongTy',search:true, width:"10%", editable:false,align:'left',edittype:"select",formatter:"select",hidden:true,editoptions:{value:congty},formoptions:{rowpos:3, colpos :1}}, 
			...
			{name:'KhoangCachDenPhongKhamLS',search:true,index:'KhoangCachDenPhongKhamLS', width:"5%", editable:false,align:'center',hidden:true,formoptions:{rowpos:3, colpos :1}}, 
			{name:'Id_tang',index:'Id_tang',search:false, width:"10%", editable:false,align:'left',edittype:"select",formatter:"select",editoptions:{value:tang},formoptions:{rowpos:4, colpos :1},hidden:true}, 
			{name:'Tang',search:true,index:'Tang', width:"5%", editable:false,align:'left',hidden:true}, 
			{name:'Id_phongcm',index:'Id_phongcm',search:false, width:"10%", editable:false,align:'left',edittype:"select",formatter:"select",editoptions:{value:phongcm},formoptions:{rowpos:5, colpos :1},hidden:true}, 
			{name:'PhongCM',search:true,index:'left', width:"5%", editable:false,align:'center',hidden:true}, 
		],
			loadonce: true,
            scroll: false,
            modal: true,
