...
jQuery(document).ready(function() {
	...
	if(window.ten_loaikham_select==''){
		...
		//----------------
			...
			parameters =
			{
				initdata : {ID_GoiKhamChiTiet: window.id_loaikham_select,TenLoaiKham:window.ten_loaikham_select,GiaBaoChoBN:window.gia_loaikham_select},
				position :"last",
				useDefValues : false,
				useFormatter : false,
