...
jQuery(document).ready(function() {	
	...
	$("#rowed3").jqGrid('setGridParam',{url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_cty_kh',datatype:'json'}).trigger('reloadGrid');
...
function create_grid(){	
	...
	colModel:[
            {name:'TenCty',index:'TenCty',search:true, width:"300%",editrules: {required:true}, editable:true,align:'left',},		   	 	 
			{name:'MaVietTat',index:'MaVietTat',search:true, width:"100%", editable:true,align:'left',hidden:false}, 
			{name:'DiaChi',index:'DiaChi', width:"300%", editable:true,align:'left',hidden:false,edittype:"textarea",formoptions:{},sorttype:'text'},
			{name:'DienThoai',index:'DienThoai',search:true, width:"100%", editable:true,align:'left',edittype:"text",hidden:false,formoptions:{}},		 
			{name:'Email',index:'Email',search:true, width:"200%", editrules:{email:true,required:false},editable:true,align:'left',hidden:false,},
			{name:'Fax',index:'Fax',search:true, width:"100%", editable:true,align:'left',hidden:false,},
			{name:'SoTaiKhoan',index:'SoTaiKhoan',search:true, width:"100%", editable:true,align:'center',hidden:false,},
			{name:'ID_NganHang',index:'ID_NganHang',search:true, width:"100%", editable:true,align:'center',editrules:{integer:true},hidden:false,},
			{name:'NguoiLienHe',index:'NguoiLienHe',search:true, width:"100%", editable:true,align:'left',},
			{name:'DTNguoiLienHe',index:'DTNguoiLienHe',search:true, width:"100%", editable:true,align:'left',},
