...
if(trim($_POST['TruongHopBHYT_hidden'])==99){
 $_POST['TruongHopBHYT_hidden']=NULL;
        ...
        $params = array(
          ...
          $_POST['TruongHopBHYT_hidden'],// Truong hop BHYT,
          $IsHoTro, 
          $_POST['Loai_hidden'],   
          $_POST['GiaKSKCT'],
          $_SESSION['user']['id_user'],
          ...
          if(isset($_POST['ts'])){  
           foreach ($_POST['ts'] as $key => $value) {
				...
				$params2=array($check1,$value['TenXetNghiem'],$value['MoTa'],$value['DonGia'],$value['GhiChu'],$value['CanNam1'],$value['CanNam2'],$value['CanNam3'],$value['CanNam4'],$value['CanNu1'],$value['CanNu2'],$value['CanNu3'],
					$value['CanNu4'],$value['Red'],$value['Blue'],$value['Yellow'],$value['HeSoChuyenDoi'],$value['GiaTriBinhThuong1'],$value['GiaTriBinhThuong2'],$value['CoKQInRieng'],$value['CoTemplate'],$value['STT'],$value['ID_DonViTinh'],$value['Active'],$_SESSION['user']['id_user'],);
				//print_r($params1);
