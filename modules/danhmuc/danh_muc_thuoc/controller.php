...
function add($store_name){
      ...
      //  }
        ...
        if(!isset($_POST['ShowLoHanDung'])){    
            $ShowLoHanDung=0;
        }else{    
            $ShowLoHanDung=$_POST['ShowLoHanDung'];
        }
        ...
        if( trim($_POST['ThongTinThauBHYT']," ")==""){    
                   $_POST['ThongTinThauBHYT']=null;
        }else{    
                $_POST['ThongTinThauBHYT']=trim($_POST['ThongTinThauBHYT']," ");
        }

        if( trim($_POST['GiaBHYTSoLe'])==""){    
            $_POST['GiaBHYTSoLe']=null;
        }else{    
            $_POST['GiaBHYTSoLe']=trim($_POST['GiaBHYTSoLe']);
        }
        if(!isset($_POST['HideVienPhiNgoaiTru'])){    
            $HideVienPhiNgoaiTru=0;
        }else{    
            $HideVienPhiNgoaiTru=$_POST['HideVienPhiNgoaiTru'];
        }		
		...
		$TaoInputStore=TaoInputStore($params);
		 $store_name="{call Gd2_Thuoc_Add $TaoInputStore}";//tao bien khai bao store
...
function edit($store_name){
  ...
  $TaoInputStore=TaoInputStore($params);
  $store_name="{call Gd2_Thuoc_Upd $TaoInputStore}";//tao bien khai bao store
...
function update_hoichan(){
$table = 'DM_Thuoc';  
    $ID = 'ID_Thuoc';  
    $ID_Value = $_POST['ID_Thuoc'];
    $attributes = array(
      'isKhongDuocKeDon' => $_POST['isKhongDuocKeDon'],
      'isSuDungBHYT' => $_POST['isSuDungBHYT'],
    );
       $res = dbUpdate($table,$ID,$ID_Value,$attributes); //note: $id là tên cột là tên cột
}
?>
