...
<td><input required type=text id="dongia" name="dongia" style="width: 105px!important"> <span style="color:red;font-weight: bold;">Giá bán:*</span><input required type=text id="giaban" name="giaban" style="width: 110px!important"> </td>
<td></td>
