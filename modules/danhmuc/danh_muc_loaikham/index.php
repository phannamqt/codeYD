    ...
    <legend><strong>Thông tin chung</strong></legend>
	 <table border=0>
			<tr>
				...
				<td><input id="TenLoaiKham" name="TenLoaiKham"  type="text" style="width:250px;margin-left:5px">
				</td>
				<td>Nhóm loại khám: 
				</td>
				<td><input type="text" id="ID_NhomCLS" name="ID_NhomCLS" style="width:223px;margin-left:5px">
				</td>
			</tr>
			<tr>
				<td>Mã viết tắt:
				</td>
				<td><input type=text id="MaVietTat" name="MaVietTat" style="width: 250px!important;margin-left:5px" >
				</td>
				<td>Mã viết tắt BN: 
				</td>
				<td><input id="MaVietTat_BN" value="" name="MaVietTat_BN"  type="text" style="width:250px;margin-left:5px">
				</td> 
			</tr>
			<tr>
				<td>Tên report:
				</td>
				<td> <input id="ReportName" name="ReportName"  type="text" style="width:250px;margin-left:5px"> 
				</td>
				<td> Tên report 2:
				</td>
				<td> <input id="TenLoaiKham_EN" name="TenLoaiKham_EN"  type="text" style="width:250px;margin-left:5px">
				</td> 
			</tr>
			<tr>
				<td>Giá viện phí: 
				...
				<td>
				<input id="GiaBaoChoBN" value="" name="GiaBaoChoBN"  type="text" style="width:250px;margin-left:5px">
				</td>
				<td>VAT:
				</td>
				<td><input type="text" id="PhanTramThue" name="PhanTramThue" style="width:250px;margin-left:5px"> 
				</td> 
			</tr>
			<tr>
				<td>Giá KSK Công ty:
				</td>
				<td><input id="GiaKSKCT" name="GiaKSKCT"  type="text" style="width:250px;margin-left:5px">
				</td>
				<td>Chuyên khoa:
				</td>
				<td><input type="text" id="ID_ChuyenKhoa" name="ID_ChuyenKhoa" style="width:223px;margin-left:5px">
				</td> 
			</tr>
			<tr>
				<td>Hiển thị DS xếp hàng CLS:
				</td>
				<td><input type=checkbox id="CLS" value="1" name="CLS"><i>(Chọn nếu là CLS, bỏ chọn nếu là khám lâm sàng)</i>. 
				</td>
				<td> Sử dụng:
				</td>
				<td> <input type=checkbox id="Active" value="1" name="Active"> Là xét nghiệm: <input type=checkbox id="XetNghiem" value="1" name="XetNghiem">
				</td> 
			</tr>
		...
		<fieldset>
    	<legend><strong>Bảo hiểm y tế</strong></legend>
		<table border=0>
			<tr>
				<td>Trường hợp BHYT (01):
				</td>
				<td style="padding-right: 30px;"><input type="text" id="TruongHopBHYT" name="TruongHopBHYT" style="width:180px;margin-left:5px; text-align:right">
				</td>
				<td>Giá BHYT (06):
				</td>
				<td> <input id="GiaBaoHiem" name="GiaBaoHiem"  type="text" style="width:100px;margin-left:5px">
				</td> 
			</tr>
			...
			<tr>
				...
				<td><input id="TenBaoHiem" name="TenBaoHiem"  type="text" style="width:207px;margin-left:5px"> 
				</td> 
				<td>Phụ thu (07):
				</td>
				<td > <input id="GiaPhuThuBenhVien" name="GiaPhuThuBenhVien"  type="text" style="width:100px;margin-left:5px">
				</td>
			...
			<tr>
				...
				<td> <input type="text" id="ID_Nhom_BHYT" name="ID_Nhom_BHYT" style="width:180px;margin-left:5px">
                       <input type="text" id="ID_Nhom_BHYT_hide" name="ID_Nhom_BHYT_hide" style="display: none;">
				</td>
				<td>Loại (08):
				</td>
				<td><input type="text" id="Loai" name="Loai" style="width:72px;margin-left:5px; text-align:right">
				</td> 
			</tr>
			<tr>
				<td>Loại PT,TT (04):
				</td>
				<td><input type="text" id="ID_LoaiPhauThuat_TT" name="ID_LoaiPhauThuat_TT" style="width:180px;margin-left:5px; text-align:right">
				</td>
				<td>Số Ngày XML (09):
				</td>
				<td><input type="text" id="SoNgayXmlBHYT" name="SoNgayXmlBHYT" style="width:100px;margin-left:5px">
				</td> 
			</tr> 
			<tr>
				<td>STT BHYT (05):
				</td>
				<td><input type="text" id="STTBaoHiem" name="STTBaoHiem" style="width:207px;margin-left:5px">
				</td>
				<td>Mã số BHYT (10):
				</td>
				<td><input type="text" id="MaSoBH" name="MaSoBH" style="width:100px;margin-left:5px">
				</td> 
			</tr> 
			<tr>
				<td>Tỷ lệ thanh toán (11):<br><i>( Khám chính: 100, Khám CK 2: 30 )</i>
				</td>
				<td><input type="text" id="TyLeThanhToan_BHYT" name="TyLeThanhToan_BHYT" style="width:207px;margin-left:5px">
				</td>
				<td> 
				</td>
				<td>
...
jQuery(document).ready(function() {
	...
	create_combobox_new('#ID_ChuyenKhoa',create_chuyenkhoa,'bw','','data_chuyenkhoa',0);
	...
	create_combobox_new('#Loai',create_loaikham,'bw','[]','',0);
  ...
  var columns = [  		
			...
			{name:'Tên BHYT',id:'TenBHYT',field: "TenBHYT",width: 300},  
			{name:'Nhóm BHYT',id:'Ten_Nhom_BHYT',field: "Ten_Nhom_BHYT",width: 200},	
			{name:'Mã số BHYT',id:'MaSoTheoDVBHYT',field: "MaSoTheoDVBHYT",width: 80}, 
			{name:'Chuyên khoa',id:'tenchuyenkhoa',field: "tenchuyenkhoa",width: 100},  			
			...
			{name:'Tỷ lệ BHYT thanh toán',id:'TyLeThanhToan_BHYT',field: "TyLeThanhToan_BHYT",width: 80,formatter: currencyFmatter},
			{name:'Phụ thu',id:'GiaPhuThuBenhVien',field: "GiaPhuThuBenhVien",width: 80,formatter: currencyFmatter},			
  ...
  $(grid.getHeaderRow()).delegate(":input", "change keyup", function (e) {
	...
	grid.onDblClick.subscribe(function (e, args){
			...
			$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_loaikhambyid&id='+window.id_edit).done(function(a){
				...
				var ID_ChuyenKhoa = data.ID_ChuyenKhoa; 
				var MoTa = data.MoTa; 
				...
				var TyLeThanhToan_BHYT = data.TyLeThanhToan_BHYT;
           ...
           // $("#ID_NhomCLS").val(ID_NhomCLS);
			...
			setval_new('#ID_ChuyenKhoa',ID_ChuyenKhoa); 
            $("#MoTa").val(MoTa);
		...
		//alert(IsHoTro);
			...
			$("#TyLeThanhToan_BHYT").val(TyLeThanhToan_BHYT);
...
jQuery(window).resize(function() {		 
 ...
 function check_n(){
	...
	check_null["ID_ChuyenKhoa"]=$.trim(dataToSend["ID_ChuyenKhoa"]);
	...
	check_null["MaVietTat"]=$.trim(dataToSend["MaVietTat"]);
	check_null["MaVietTat_BN"]=$.trim(dataToSend["MaVietTat_BN"]);
	check_null["TruongHopBHYT"]=$.trim(dataToSend["TruongHopBHYT"]);
	if($("#TruongHopBHYT_hidden").val()!="99" && $("#TruongHopBHYT").val()!=""){
		...
		//check_null["Loai"]=$.trim(dataToSend["Loai"]);
		//check_null["ID_LoaiPhauThuat_TT"]=$.trim(dataToSend["ID_LoaiPhauThuat_TT"]);
		check_null["STTBaoHiem"]=$.trim(dataToSend["STTBaoHiem"]);
		check_null["MaSoBH"]=$.trim(dataToSend["MaSoBH"]);
		check_null["TyLeThanhToan_BHYT"]=$.trim(dataToSend["TyLeThanhToan_BHYT"]);
	}
...
function create_chuyenkhoa(elem, datalocal) {
	datalocal = jQuery.parseJSON(datalocal);
	$(elem).jqGrid({
	   datastr: datalocal,
		datatype: "jsonstring",
