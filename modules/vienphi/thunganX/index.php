...
jQuery(document).ready(function() {
  ...
  create_combobox('#com_dotkham','#com_dotkham1',".data_thuochmk","#data_thuochmk",create_dotkham_congty,500,240,'Danh mục ','data_ds_goikhambyidcongty',window.default_id_pb_ChuyenMon);
	...
	$('#btn_excel_doanhthu_dichvu,#btn_excel_doanhthu_thuoc_B,#btn_excel_doanhthu_thuoc,#btn_excel_doanhthu_thuoc_group,#btn_excel_doanhthu_thuoc_group_B,#btn_excel_huybill,#btn_excel_nhap_thuoc,#btn_excel_nhap_thuoc_B').button();
...
$("#xem").click(function() {
 ...
 if(window.contro=="1"){
  ...
  if(diffDays>=10){
   alert("Khoảng thời gian chọn cho phép là 10 ngày");	
 }else{							
   $.ajax({
    type: 'POST',
    async : false,
