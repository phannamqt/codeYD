         ...
         <fieldset>
                ...
                <tr>
                 ...
                 <table style="width:100%" >
					...
					if($thongtin[0]['SoTien']>0){
						echo 0;
					}else{
						echo number_format((abs($thongtin[0]['SoTien'])), 0, '', '.');
					}
...
setTimeout(function(){$("#tienthu").focus()},500); ;
	...
	$('#id_print').keydown(function(e){
			...
			if($('#id_print').val()==4){
			 ...
			 dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=phieu_thu&header=top&lien="+$('#id_print').val()+"&type=report&tenreport=1&id_form=10&idthutrano="+window.ID_ThuTraNo,'PhieuThu');
			 $('#dialog_print').dialog('close');
			}
   ...
   $('#btn_luu').click(function(){	   
	   ...
	   $('#btn_lien1').click(function(){
			 ...
			 dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=phieu_thu&header=top&tenreport=1&lien=2&type=report&id_form=10&idthutrano="+window.ID_ThuTraNo,'PhieuThu');
			 $('#dialog_print').dialog('close');	   
	   })
	   $('#btn_lien2').click(function(){
	   		$.cookie("in_status", "print_preview"); 
			dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=phieu_thu&header=top&tenreport=1&lien=3&type=report&id_form=10&idthutrano="+window.ID_ThuTraNo,'PhieuThu');
			$('#dialog_print').dialog('close');	   
	   })
   phanquyen();
