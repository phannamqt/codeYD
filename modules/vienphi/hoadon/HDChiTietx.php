  ...
  function create_grid() {
        $("#rowed30").jqGrid({
            ...
            colModel: [
                ...
                {name: 'TienVat',formatter:"currency",formatoptions:{decimalSeparator:".", thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},sorttype:"number", summaryType: 'sum',index: 'TienVat', search: false, width: "10%", editable: false, align: 'right', hidden: false},
