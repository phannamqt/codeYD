...
<?php
  ...
  if(isset($_GET["ID_HoaDonThueDiary"])){
  ...
  {
        echo "<script type='text/javascript'>";
        echo "window.ID_HoaDonThueDiary=0";
        echo "</script>";
     ...
     <div class="ui-layout-east n_tren" >
       ...
       <div class="tt_phai2">
            ...
            <div class="nut" >
              ...
              <button href="#" id="excel" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="margin-left:0px;  margin-bottom:1px; ">Excel BK </button>
              <button href="#" id="pxKho" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="margin-left:0px;  margin-bottom:1px; ">P.Xuất kho </button>
              ...
              <button href="#" id="Xoa" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="margin-left:0px;  margin-bottom:1px; ">Xóa</button>
              <button href="#" id="XemInNew" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="margin-left:0px;  margin-bottom:1px; ">In mẫu mới</button>
            </div>
     ...
     <div id="dsBill" class="ui-layout-center n_duoi">
          <div id="tabs">
               <ul style="margin-left:5px;">
                ...
                <li><a href="#tabs-2" id="chitietnew">Chi tiết dịch vụ - Form mới</a></li>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
     ...
     if (typeof window.ID_ThuTraNoMulti!='undefined')
     {
           ...
           window.url_rowed40 = 'pages.php?module=vienphi>&view=hoadon&action=data_HoaDonChiTiet&ID_ThuTraNo='+ window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+'&ID_ThuTraNoMulti='+window.ID_ThuTraNoMulti
         ...
         }else
         {
               ...
               window.url_rowed40 = 'pages.php?module=vienphi>&view=hoadon&action=data_HoaDonChiTiet&ID_ThuTraNo='+ window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD;;
...
if(typeof window.ID_ThuTraNoMulti !='undefined'){
 ...
 $.post('pages.php?module=vienphi&view=hoadon&action=controller_luuHoaDon&ID_TTNo='+ID_ThuTNo,dataToSend)
                                 .done(function( data ) {
...
function resize_control() {
 ...
 $("#chitietnew").setGridHeight($('.n_tren').height());

  $("#rowed30").setGridHeight($("#tabs-1").height()-120);
  $("#rowed30").setGridWidth($("#tabs-1").width());
  $("#rowed40").setGridHeight($("#tabs-2").height()-120);
  $("#rowed40").setGridWidth($("#tabs-2").width());
}
 $('#XemIn').click(function(){
  ...
  $('#XemInNew').click(function(){


      $.cookie("in_status", "print_preview");
           dialog_report("Xem trước khi in",90,90,"u78787878975f","pages.php?module=report&view=vienphi&action=hoadonmoi&header=top&lien=3&type=report&id_form=11&kieuin=1&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti,'hoadonmoi');
          $('#dialog_print').dialog('close');

        })

  $('#pxKho').click(function(){



if(window.phanloaiHD=='6'||window.phanloaiHD=='10'||window.phanloaiHD=='5'||window.phanloaiHD=='11')
{
      $.cookie("in_status", "print_preview");
           dialog_report("Xem trước khi in",90,90,"u78787878975f","pages.php?module=report&view=vienphi&action=phieuxuatkho_hoadon&header=top&lien=3&type=report&id_form=11&kieuin=1&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti,'BangKeHoaDon');
          $('#dialog_print').dialog('close');
}
         ...
         if(window.phanloaiHD=='6'||window.phanloaiHD=='10'||window.phanloaiHD=='5'||window.phanloaiHD=='11')
          {
                    ...
                    window.open("pages.php?module=report&view=vienphi&action=bangkehoadonThuoc_Excel&type=excel&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti);

          }
          else if(window.phanloaiHD=='9'||window.phanloaiHD=='8'||window.phanloaiHD=='7'||window.phanloaiHD=='1')
         {
           window.open("pages.php?module=report&view=vienphi&action=BangKeHoaDonKCB_Excel&type=excel&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti);
...
{
      $.cookie("in_status", "print_preview");
           dialog_report("Xem trước khi in",90,90,"u78787878975f","pages.php?module=report&view=vienphi&action=bangkehoadon&header=top&lien=3&type=report&id_form=11&kieuin=1&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti,'BangKeHoaDon');
          $('#dialog_print').dialog('close');
}
  else if(window.phanloaiHD=='9'||window.phanloaiHD=='8'||window.phanloaiHD=='7'||window.phanloaiHD=='1')
  {
    $.cookie("in_status", "print_preview");
           dialog_report("Xem trước khi in",90,90,"u78787878975f","pages.php?module=report&view=vienphi&action=BangKeHoaDonKCB&header=top&lien=3&type=report&id_form=11&kieuin=1&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti,'BangKeHoaDonKCB');
          $('#dialog_print').dialog('close');
  }
        })
 ...
 $('#Xoa').click(function(){
  ...
  var soHdHuy=$("#soHD").val();
  $('<div></div>').appendTo('body')
  .html('<div><h2 style="color:red">Bạn có chắc là Xóa hóa đơn '+soHdHuy+'?</h2></div>')
  .dialog({
    modal: true,
    title: 'Sau khi xóa, số hóa đơn này sẽ dùng lại được cho phiếu sau) ?!!',
    zIndex: 10000,
    autoOpen: true,
    width: '700px',
    resizable: false,
    buttons: {
      Yes: function () {
        postTo='pages.php?module=vienphi&view=hoadon&action=controller_luuHoaDon&opper=Xoa'+'&soHdXoa='+soHdHuy+'&_ID_HoaDonThueDiary='+_ID_HoaDonThueDiary;
        $.post(postTo).done(function(data){

        })


        tooltip_message("Đã xóa hóa đơn");
        $(this).dialog("close");
      },
      No: function () {
       tooltip_message("Chưa xóa hóa đơn");
       $(this).dialog("close");
     }
   },
   close: function (event, ui) {
 ...
 $(elem).jqGrid('bindKeys', {});
  ...
  function create_grid() {
        $("#rowed30").jqGrid({
            ...
            datatype: "json",
            colNames: ['Tên nhóm','SL','Giá','T tiền','Giá trước V','TT trước V','Vat','TiềnVAT'],
            colModel: [
                ...
                {name: 'DonGia',formatter:"currency",formatoptions:{decimalSeparator:".", thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},sorttype:"number", summaryType: 'sum',index: 'DonGia', search: false, width: "10%", editable: false, align: 'right', hidden: false},
                {name: 'ThanhTien',formatter:"currency",formatoptions:{decimalSeparator:".", thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},sorttype:"number", summaryType: 'sum',index: 'ThanhTien', search: false, width: "10%", editable: false, align: 'right', hidden: false},
                {name: 'GiaTruocVAT',formatter:"currency",formatoptions:{decimalSeparator:".", thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},sorttype:"number", summaryType: 'sum',index: 'GiaTruocVAT', search: false, width: "10%", editable: false, align: 'right', hidden: false},
                {name: 'ThanhTienTruocVAT',formatter:"currency",formatoptions:{decimalSeparator:".", thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},sorttype:"number", summaryType: 'sum',index: 'ThanhTienTruocVAT', search: false, width: "10%", editable: false, align: 'right', hidden: false},
                {name: 'PhanTramThue',formatter:"currency",formatoptions:{decimalSeparator:".", thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},sorttype:"number", summaryType: 'sum',index: 'PhanTramThue', search: false, width: "10%", editable: false, align: 'right', hidden: false},
                {name: 'TienVat',formatter:"currency",formatoptions:{decimalSeparator:".", thousandsSeparator: ".", decimalPlaces: 0, prefix: ""},sorttype:"number", summaryType: 'sum',index: 'TienVat', search: false, width: "10%", editable: false, align: 'right', hidden: true},
         ...
         var ids = $('#rowed30').jqGrid('getDataIDs');
           for (i = 0; i < ids.length; i++) {
                    ...
                    if (rowData["Ten_Nhom_BHYT"] == "Tổng thu") {
                      ...
                      if (rowData["Ten_Nhom_BHYT"] == "Thuế suất") {
                        $("#rowed30").setCell(ids[i], 'Ten_Nhom_BHYT', '', {background: '#FFF', color: 'blue'});
                         $("#rowed30").setCell(ids[i], 'PhanTramThue', '', {background: '#FFF',color: 'blue'});
                          $("#rowed30").setCell(ids[i], 'TienVat', '', {background: '#FFF',color: 'blue'});
