...
foreach ($tam as $row) {//duyet toan bo mang tra ve
	...
	if($row["NgayGioGioiThieu"]!='')
			$row["NgayGioGioiThieu"]=$row["NgayGioGioiThieu"]->format($_SESSION["config_system"]["ngaythang"]);
	else $row["NgayGioGioiThieu"]='';
	...
	$row["ThongSoKyThuat"],//Đánh giá thông số
	$row["NgayGioGioiThieu"],
	);
    $i++; 
}
