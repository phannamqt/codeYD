...
$data= new SQLServer;//tao lop ket noi SQL 
 ...
 $param3=NULL;
 $param4=NULL;
$store_name="{call GD2_LayDSXepHangCanLamSang_GroupXetNghiem_TheoNhom(?,?,?,?)}";//tao bien khai bao store
...
$_store_name="{call GD2_LayDSXepHangCanLamSang_GroupXetNghiem_TheoNhom(?,?,?,?)}";//tao bien khai bao store GD2_LayDSXepHangCanLamSang
...
$param11=$_GET["id"];
 ...
 $param33=NULL;
 $param44=NULL;
$store_name1="{call GD2_LayDSXepHangCanLamSang_GroupXetNghiem_TheoNhom(?,?,?,?)}";//tao bien khai bao store
