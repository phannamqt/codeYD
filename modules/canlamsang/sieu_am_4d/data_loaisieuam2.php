...
$params = array('sieu_am_4d',$_GET["idbenhnhan"],$_GET["idkham"]);//tao param cho store 
$store_name="{call GD2_US4d_KhamGetDataByTenFormAndIDBenhNhanAndIdKham_V2(?,?,?)}";//tao bien khai bao store
