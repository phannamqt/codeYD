...
<body>
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_luotkham" id="right_col">  	 
    	...
    	<a href="#" id="mri_report_english" class="fm-button ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px;  margin-bottom:1px;float: right; ">English<span class="ui-icon ui-icon-note"></span></a>
    	</div>
...
$("#xemin").click(function(e){	
    ...
    $("#mri_report_english").click(function(e){
        // alert("11");
