...
$params = array('do_xo_vua_dong_mach_abi',$_GET["idbenhnhan"]);//tao param cho store 
$store_name="{call GD2_ABI_GetDataByTenFormAndID_BenhNhan(?,?)}";//tao bien khai bao store
