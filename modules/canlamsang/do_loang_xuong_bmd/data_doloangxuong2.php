...
$params = array('do_loang_xuong_bmd',$_GET["idbenhnhan"],$_GET["idkham"]);//tao param cho store 
$store_name="{call GD2_BMD_Select_ByIdBenhNhan_and_ID_Kham(?,?,?)}";//tao bien khai bao store
