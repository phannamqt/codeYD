...
$("#xemin").click(function(e){	
		$.cookie("in_status", "print_preview"); 
		dialog_report("Xem trước khi in",90,90,"u78787878975f","pages.php?module=report&view=<?=$modules?>&action=xray&header=top&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10&chuky="+chuky,'SieuAmXRay');
		$(".frame_u78787878975f").css("width","793px");
	});
	/* $("#xemin").click(function(e){	
	$.cookie("in_status", "print_preview"); 	
		if($('#chonanh').is( ":checked" )) {
			...
			print_action="xemin";
		dialog_pic_select("Chọn ảnh",90,"170px","u78787878975f",window.search_string,"SieuAmXRay",print_action,"KẾT QUẢ XQUANG","XRAY REPORT","Bác sĩ XQUANG","left",3,"xray",'<?=$modules?>',"780");		
		}
		
		//dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmXRay",print_action,"KẾT QUẢ XQUANG","XRAY REPORT","Bác sĩ XQUANG","left",3,"xray",'<?=$modules?>',"780");		
