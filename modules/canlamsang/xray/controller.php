...
function luudangkham($store_name){
	...
	$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(trim($_POST['nguoithuchien']," "),trim($_POST['chuandoan1']," "),($_POST["mota"]),($_POST["thongsokt"]),($_POST["ketluan"]),($_POST["loikhuyen"]),($_POST["id_kham"]),($_POST["id_trangthai"]),0,0);
