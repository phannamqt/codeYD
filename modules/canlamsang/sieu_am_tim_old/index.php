...
<script type="text/javascript">
	...
	$(document).ready(function() {	 
	  ...
	  dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"InDonThuoc_Bsy",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","Bác sĩ SIÊU ÂM","left",6,"sieuam_kieu2",'<?=$modules?>');
	});
		...
		{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"sieuam",print_action,"PHIẾU SIÊU ÂM DOPPLER MÀU TỔNG QUÁT","GENERAL ULTRASOUND","Bác sĩ SIÊU ÂM","left",3,"sieuam",'<?=$modules?>',"780");	
		}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"sieuam",print_action,"PHIẾU SIÊU ÂM DOPPLER MÀU TỔNG QUÁT","GENERAL ULTRASOUND","Bác sĩ SIÊU ÂM","left",3,"sieuam_khongchuky",'<?=$modules?>',"780");
		}	
