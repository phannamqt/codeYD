...
$(document).ready(function() {	 
	...
	$("#xemin").click(function(e){	
		...
		dialog_report("Xem trước khi in",90,90,"u78787878975f","pages.php?module=report&view=<?=$modules?>&action=ctg&header=left&id_benhnhan="+id_benhnhan+"&id_luotkham="+_id_luotkham2+"&type=report&id_form=10&id_kham="+_kham+"&chuky="+chuky,'xetnghiem');
