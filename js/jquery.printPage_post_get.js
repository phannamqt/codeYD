 ...
 * @licence: MIT
 * @desciption: jQuery page print plugin with post and get method
 */
 ...
 $.fn.makeExpandMenu = function (config) {	  
	...
	var flag=0;
	function create_iframe(el,config,callback){
		var url = (config.url) ? config.url : $(el).attr(config.attr);
